...
siconos::mechanisms::myExtrema_ExtSS::myExtrema_ExtSS() {
...
{
  Initialize(S2, S2.FirstUParameter(), S2.LastUParameter(),
             S2.FirstVParameter(), S2.LastVParameter(), TolS2);

  Perform(S1, S1.FirstUParameter(), S1.LastUParameter(), S1.FirstVParameter(),
...
void siconos::mechanisms::myExtrema_ExtSS::Initialize(
    const Adaptor3d_Surface& S2, const Standard_Real Uinf2,
    const Standard_Real Usup2, const Standard_Real Vinf2,
    const Standard_Real Vsup2, const Standard_Real TolS2) {
...
void siconos::mechanisms::myExtrema_ExtSS::Perform(const Adaptor3d_Surface& S1,
...
Standard_Boolean siconos::mechanisms::myExtrema_ExtSS::IsDone() const {
  return myDone;
}

Standard_Boolean siconos::mechanisms::myExtrema_ExtSS::IsParallel() const {
  return myIsPar;
}

Standard_Real siconos::mechanisms::myExtrema_ExtSS::Value(
...
Standard_Integer siconos::mechanisms::myExtrema_ExtSS::NbExt() const {
  if (!myDone) StdFail_NotDone::Raise();
  return myvalue.Length();
}

void siconos::mechanisms::myExtrema_ExtSS::Points(const Standard_Integer N,
                                                  Extrema_POnSurf& P1,
