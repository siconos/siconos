 ...
 * computation between CAD objects. The MBTB computation algorithm uses either
 * this or qnb.f.
 */
//! The math_FunctionSetRoot class calculates the root <br>
//! of a set of N functions of M variables (N<M, N=M or N>M). Knowing <br>
//! an initial guess of the solution and using a minimization algorithm, a
//! search <br> is made in the Newton direction and then in the Gradient
//! direction if there <br> is no success in the Newton direction. This
//! algorithm can also be <br> used for functions minimization. Knowledge of all
//! the partial <br> derivatives (the Jacobian) is required. <br>
class mymath_FunctionSetRoot {
 public:
  ...
  //! StartingPoint. infBound and supBound may be given to constrain the
