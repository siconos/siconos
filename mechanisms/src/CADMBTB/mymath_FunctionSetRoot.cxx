...
namespace siconos::mechanisms::internal {  // Local only

const Standard_Boolean kMyDebug = Standard_False;
...
class MyDirFunction : public math_Function {
 ...
 public:
  ...
  //					   Standard_Real& F2, Standard_Real&
  // Gnr1);
...

{
  ...
  if (kMyDebug) {
    std::cout << "     essai d interpolation" << std::endl;
  }
...
siconos::mechanisms::mymath_FunctionSetRoot::mymath_FunctionSetRoot(
    math_FunctionSetWithDerivatives& F, const Standard_Integer NbIterations)
    : Delta(1, F.NbVariables()),
      Sol(1, F.NbVariables()),
      DF(1, F.NbEquations(), 1, F.NbVariables()),
      Tol(1, F.NbVariables()),
...
siconos::mechanisms::mymath_FunctionSetRoot::mymath_FunctionSetRoot(
    math_FunctionSetWithDerivatives& F, const math_Vector& StartingPoint,
    const math_Vector& Tolerance, const Standard_Integer NbIterations)
    : Delta(1, F.NbVariables()),
      Sol(1, F.NbVariables()),
      DF(1, F.NbEquations(), 1, StartingPoint.Length()),
      Tol(1, F.NbVariables()),
...
void siconos::mechanisms::mymath_FunctionSetRoot::Perform(
  ...
  internal::MyDirFunction F_Dir(Temp1, Temp2, Temp3, Temp4, F);
...
Standard_Boolean siconos::mechanisms::mymath_FunctionSetRoot::IsSolutionReached(
