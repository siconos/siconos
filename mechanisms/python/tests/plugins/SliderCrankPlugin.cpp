...
extern "C" void internalForcesB1(double t, double* q, double* v, double* f,
...
extern "C" void internalForcesB1_Jacq(double t, double* q, double* v, double* jac,
                                      unsigned int size_z, double* z) {
  for (int i = 0; i < 3; i++) {
    for (int j = 0; j < 7; j++) jac[i + j * 3] = 0.0;
  }
  jac[2 + 2 * 3] = 1e4;
...
extern "C" void internalMomentsB1(double t, double* q, double* v, double* m,
                                  unsigned int size_z, double* z) {
...
extern "C" void internalMomentsB1_Jacq(double t, double* q, double* v, double* jac,
                                       unsigned int size_z, double* z) {
...
extern "C" void prescribedvelocityB1(double time, unsigned int sizeofprescribedvelocity,
                                     double* pv) {
