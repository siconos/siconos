# ======================================================================
# Debug mode (more warnings, ...), all components, no doc, some deps ...
#
#
#
# =======================================================================
...
set(COMPONENTS externals numerics kernel  mechanics io CACHE INTERNAL "List of siconos components to build and install")
option(WITH_PYB11_WRAPPER "Build and install python bindings" ON)

# --- Build/compiling options ---
set(WARNINGS_LEVEL 2 CACHE INTERNAL "Set compiler diagnostics level. 0: no warnings, 1: developer's minimal warnings, 2: strict level, warnings to errors and so on.")
