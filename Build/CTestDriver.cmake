...
set(CTEST_CONFIGURE_COMMAND "${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE:STRING=${CTEST_BUILD_CONFIGURATION} -DBUILDNAME:STRING=${MODULE} -DWITH_TESTING:BOOL=ON -DWITH_TESTS_COVERAGE:BOOL=ON ${CTEST_BUILD_OPTIONS} ${EXTRA_CMAKE_ARGS} ${CTEST_SOURCE_DIRECTORY}")
