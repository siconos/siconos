...
def xml2rst(headername, srcdir, component_name, sphinx_directory, doxyconf):
    ...
    for f in xml_files:
        ...
        if f.find('class') > -1 or f.find('struct') > -1:
            ...
            lenname = len(title)
            title = label + title + '\n' + lenname * '=' + '\n\n'
            pgm = 'Defined in :ref:`pgm_' + refname + '`' + '\n\n'
            gen = title + pgm            
            ...
            lenname = len(title)
            title = label + title + '\n' + lenname * '=' + '\n\n'
            pgm = ':ref:`Go to the source code of this file <pgm_' + refname + '>`' + '\n\n'
            gen = title + pgm
...
def create_rst_for_program(headername, srcdir, sphinx_directory, filterdox=False):
    ...
    lenname = len(title)
    title = label + title + '\n' + lenname * '=' + '\n\n'
    doc = '* Return to documentation for :ref:`this file<file_' + refname + '>`\n\n'
