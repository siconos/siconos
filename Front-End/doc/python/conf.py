# -*- coding: utf-8 -*-
#
# Siconos documentation build configuration file, created by
...
project = u'Siconos'
copyright = u'2013-2015, siconos-team'
...
latex_documents = [
  ('index', 'Siconos.tex', u'Siconos Documentation',
   u'siconos-team', 'manual'),
]
...
man_pages = [
    ('index', 'siconos', u'Siconos Documentation',
     [u'siconos-team'], 1)
]
...
texinfo_documents = [
  ('index', 'Siconos', u'Siconos Documentation',
   u'siconos-team', 'Siconos', 'One line description of project.',
   'Miscellaneous'),
]
