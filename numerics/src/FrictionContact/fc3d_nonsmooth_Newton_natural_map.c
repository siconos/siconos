...
void nonsmoothEqnNaturalMapFun(void* arg, unsigned int problemSize, double* reaction,
...
void nonsmoothEqnNaturalMapFun(void* arg, unsigned int problemSize, double* reaction,
  ...
  fc3d_NaturalMapFunction(problemSize, acparams_p->computeACFun3x3, reaction, velocity, mu,
                          rho, result, A, B);
}
