...
enum FRICTION_SOLVER
{
  ...
  SICONOS_GLOBAL_FRICTION_3D_NSGS_SEP_WR = 622, // separate sub-problems for convex case
...
enum SICONOS_FRICTION_3D_IPM_IPARAM_LS_FORM_ENUM
{
  ...
  SICONOS_FRICTION_3D_IPM_IPARAM_LS_4X4_TEST7 = 22,
  SICONOS_FRICTION_3D_IPM_IPARAM_LS_2X2_QPH_TEST = 23,
};
