...
enum FRICTION_SOLVER
{
  ...
  SICONOS_FRICTION_3D_GLOBAL_NSN_AC_WR = 606,
  SICONOS_FRICTION_3D_GLOBAL_AC = 607,
  SICONOS_FRICTION_3D_GLOBAL_GAMS_PATH = 608,
  SICONOS_FRICTION_3D_GLOBAL_GAMS_PATHVI = 609
...
extern char *  SICONOS_FRICTION_3D_GLOBAL_NSN_AC_WR_STR ;
