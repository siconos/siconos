...
#define SICONOS_FRICTION_3D_ADMM_GET_PROBLEM_INFO_ENUM \
  SICONOS_FRICTION_3D_ADMM_GET_PROBLEM_INFO
...
#define SICONOS_FRICTION_3D_ADMM_PRINTING_LIKE_IPM_ENUM \
  SICONOS_FRICTION_3D_ADMM_PRINTING_LIKE_IPM
...
#define SICONOS_FRICTION_3D_IPM_NESTEROV_TODD_SCALING_METHOD_ENUM \
  SICONOS_FRICTION_3D_IPM_NESTEROV_TODD_SCALING_METHOD
#define SICONOS_FRICTION_3D_IPM_IPARAM_REDUCED_SYSTEM_METHOD_ENUM \
...
#define SICONOS_FRICTION_3D_IPM_IPARAM_FINISH_WITHOUT_SCALING_ENUM \
  SICONOS_FRICTION_3D_IPM_IPARAM_FINISH_WITHOUT_SCALING
#define SICONOS_FRICTION_3D_IPM_IPARAM_REFINEMENT_ENUM \
