...
char *  SICONOS_FRICTION_3D_NSN_NM_STR = "F3D_NSN_NM";
...
char *  SICONOS_FRICTION_3D_ONECONTACT_NSN_AC_STR = "F3D_ONECONTACT_NSN_AC";
char *  SICONOS_FRICTION_3D_ONECONTACT_NSN_AC_GP_STR = "F3D_ONECONTACT_NSN_AC_GP";
