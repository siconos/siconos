...
void fc3d_nsgs_initialize_local_solver_velocity(SolverPtr* solve, FreeSolverPtr* freeSolver,
...
void fc3d_nsgs_velocity(FrictionContactProblem* problem, double* reaction, double* velocity,
  ...
  fc3d_nsgs_initialize_local_solver_velocity(&local_solver, &freeSolver, &computeError,
