...
void fc3d_proximal(FrictionContactProblem* problem, double* reaction, double* velocity,
  ...
  if (options->iparam[SICONOS_FRICTION_3D_PROXIMAL_IPARAM_STRATEGY] ==
  ...
  /*     DEBUG_PRINTF("iter_internalsolver = %i\n",iter_internalsolver); */
  /*     DEBUG_PRINTF("info = %i\n",*info); */
  /*     DEBUG_PRINTF("options->iparam[SICONOS_IPARAM_ITER_DONE] =
     %i\n",options->iparam[SICONOS_IPARAM_ITER_DONE]); */
  /*     DEBUG_PRINTF("alpha = %8.4e\n",alpha); */
  ...
  /*     if (verbose > 0) */
  /*       printf("---- FC3D - PROXIMAL - Iteration %i Residual = %14.7e with alpha =
     %12.8e\n\n", iter, error, alpha); */
  /*     if (isVariable) */
  /*     { */
  /*       alpha_old =alpha; */
