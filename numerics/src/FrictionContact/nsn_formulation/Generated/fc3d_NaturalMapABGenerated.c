...
void fc3d_NaturalMapABGenerated(double rn, double rt1, double rt2, double un, double ut1,
  ...
  if (x31) {
    ...
    /*@ assigns result[4]; */
    result[4] = x78 * (x24 * (rt1 * x90 - rt1 * x91 + x35 * x89 - x38 * x89) + x79 * x82 -
                       x79 * x84 + x85 * x86 + x87 * x88);
  ...
  if (x31) {
    ...
    /*@ assigns result[8]; */
    result[8] = x78 * (x24 * (rt2 * x105 - rt2 * x88 + x124 * x35 - x124 * x38) + x79 * x86 +
                       x82 * x85 - x84 * x85 + x87 * x91);
  ...
  if (x70) {
    /*@ assigns result[13]; */
    result[13] =
        -x112 * x12 + x113 * x99 - x93 * (-x114 + x95 * x99) - x98 * (x114 + x115 * x95) + 1;
  ...
  if (x46) {
    ...
    /*@ assigns result[17]; */
    result[17] =
        -x112 * x15 + x113 * x125 - x93 * (-x114 + x125 * x95) - x98 * (x114 + x126 * x95) + 1;
  }
}
#ifdef __FRAMAC__
int main() {
