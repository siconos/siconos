...
*/
void mcp_newton_FB_FBLSA(MixedComplementarityProblem* problem, double* z, double* Fmcp,
...
int mcp_compute_error(MixedComplementarityProblem* problem, double* z, double* w,
                      double* error);
/**
   Initialisation of the MCP solver (set problem, allocate working memory and so on. This
   routine must be called before any attempt to run the mcp_old_driver.
