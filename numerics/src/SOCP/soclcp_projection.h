 ...
 * \param options
 */
void soclcp_projection_update(int number, SecondOrderConeLinearComplementarityProblem* problem,
                              SecondOrderConeLinearComplementarityProblem* localproblem,
...
void soclcp_projection_update_with_regularization(
    int number, SecondOrderConeLinearComplementarityProblem* problem,
 ...
 * \return 0 if successfull
 */
int soclcp_projectionOnCone_v_solve(SecondOrderConeLinearComplementarityProblem* localproblem,
                                    double* r, SolverOptions* options);
