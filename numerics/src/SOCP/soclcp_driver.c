...
int soclcp_driver(SecondOrderConeLinearComplementarityProblem* problem, double* r, double* v,
  ...
  switch (options->solverId) {
    ...
    /* { */
    /*   numerics_printf(numerics_printf(" ========================== Call NSGSV solver for
     * Second Order Cone LCP problem ==========================\n"); */
    ...
    /* { */
    /*   numerics_printf(numerics_printf(" ========================== Call PROX (Proximal
     * Point) solver for Second Order Cone LCP problem ==========================\n"); */
    ...
    /* { */
    /*   numerics_printf(" ========================== Call TFP (Tresca Fixed Point) solver for
     * Second Order Cone LCP problem ==========================\n"); */
    ...
    case SICONOS_SOCLCP_VI_EG: {
      numerics_printf(
          " ========================== Call VI_ExtraGradient (VI_EG) solver for Second Order "
          "Cone LCP problem ==========================\n");
    ...
    /* { */
    /*   numerics_printf(" ========================== Call Hyperplane Projection (HP) solver
     * for Second Order Cone LCP problem ==========================\n"); */
    ...
    /* { */
    /*   numerics_printf(" ========================== Call Alart Curnier solver for Second
     * Order Cone LCP problem ==========================\n"); */
    ...
    /* { */
    /*   numerics_printf(" ========================== Call Fischer Burmeister solver for Second
     * Order Cone LCP problem ==========================\n"); */
    ...
    /* { */
    /*   numerics_printf(" ========================== Call Quartic solver for Second Order Cone
     * LCP problem ==========================\n"); */
...
int soclcp_checkTrivialCase(SecondOrderConeLinearComplementarityProblem* problem, double* v,
  ...
  for (i = 0; i < nc; i++) {
    ...
    if (q[normal] < -DBL_EPSILON) return -1;
  }
  for (i = 0; i < n; ++i) {
    v[i] = q[i];
    r[i] = 0.;
