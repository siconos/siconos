 ...
 */
enum GENERIC_MECHANICAL_SOLVER { SICONOS_GENERIC_MECHANICAL_NSGS = 2000 };
...
enum GENERIC_MECHANICAL_IPARAM {
  ...
  SICONOS_GENERIC_MECHANICAL_IPARAM_WITH_RELAXATION = 19,
};

enum GENERIC_MECHANICAL_DPARAM {
  SICONOS_DPARAM_GMP_RELAXATION_ERROR = 18,
  SICONOS_DPARAM_GMP_RELAXATION_COEFF = 19,
};

/**\enum GENERIC_MECHANICAL_ISREDUCED Possible values for
 * iparam[GENERIC_MECHANICAL_IPARAM_ISREDUCED]  */
enum GENERIC_MECHANICAL_ISREDUCED {
  SICONOS_GENERIC_MECHANICAL_GS_ON_ALLBLOCKS = 0,  // GS on all blocks
  SICONOS_GENERIC_MECHANICAL_SUBSTITUTE_EQUALITIES = 1,  // The equalities are substituted
  SICONOS_GENERIC_MECHANICAL_ASSEMBLE_EQUALITIES =
      2,                                     // Equalities are assembled in one block
