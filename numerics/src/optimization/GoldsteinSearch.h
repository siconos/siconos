 ...
 * \return the coefficient alpha
 */
static inline double linesearch_Goldstein2(int n, double theta, double preRHS,
                                           search_data* ls_data) {
  return line_search_generic(n, theta, preRHS, ls_data, LINESEARCH,
                             &search_Goldstein_standalone);
}
 ...
 * \return the coefficient alpha
 */
static inline double arcsearch_Goldstein2(int n, double theta, double preRHS,
                                          search_data* ls_data) {
  return line_search_generic(n, theta, preRHS, ls_data, ARCSEARCH,
                             &search_Goldstein_standalone);
}
