...
REGISTER_SOLVER(SICONOS_MLCP_PATH, "MLCP_PATH",
                "PATH solver for Mixed Linear Complementarity Problems", mlcp_path_init_wrap,
                mlcp_path_solve_wrap, NULL,  /* free function */
                NULL,                        /* error function */
                mlcp_path_set_default, 1000, /* default_max_iter */
                1e-6,                        /* default_tol */
                0 /* is_local_solver */);
