...
int mlcp_enum_alloc_working_memory(MixedLinearComplementarityProblem* problem,
                                   SolverOptions* options);
/*free the Work memory, and set pointer to zero.*/
void mlcp_enum_free_working_memory(MixedLinearComplementarityProblem* problem,
                                   SolverOptions* options);
#endif  // MLCP_ENUM_H
