 ...
 * \param out is the result vector of eigenvalues
 * (out\in\mathbb{R}^{2*varsCount})..
 */
void JA_eigenvals(const double* const vec, const unsigned int vecSize,
 ...
 * \param vecSize is the length of the vector.
 * \param varsCount is the count of variables (subvectors) in vec.
 * \param out is the result matrix of eigenvactors
 * (out\in\mathbb{R}^{vecSize\times 2*varsCount}).
 */
void JA_eigenvecs(const double* const vec, const unsigned int vecSize,
                  const size_t varsCount, double** out);
 ...
 */
void JA_sqrt(const double* const vec, const unsigned int vecSize,
             const size_t varsCount, double* out);
 ...
 */
void JA_sqrt_inv(const double* const vec, const unsigned int vecSize,
                 const size_t varsCount, double* out);
 ...
 */
void JA_power2(const double* const vec, const unsigned int vecSize,
               const size_t varsCount, double* out);
 ...
 */
void JA_inv(const double* const vec, const unsigned int vecSize,
            const size_t varsCount, double* out);
 ...
 */
void JA_det(const double* const vec, const unsigned int vecSize,
            const size_t varsCount, double* out);
...
/*
  \return the square of 2-norm of a vector - uses long double - based on
   blas_dnrm2
  \param n size of the vector \param x the input vector
*/
float_type dnrm2sqrl(const unsigned int n, const double* x);

/* \return the product Q_sqrt(x)*y */
void Qx05y(const double* const x, const double* const y,
           const unsigned int vecSize, const size_t varsCount, double* out);

/* PA: Return the product Q_inv_sqrt(x)*y */
void Qx50y(const double* const x, const double* const y,
           const unsigned int vecSize, const size_t varsCount, double* out);

/* PA: Jordan algebra, returns inv(x) */
void Jinv(const double* const x, const unsigned int vecSize,
          const size_t varsCount, double* out);

/* PA: Return J_sqrt(x) */
void Jsqrt(const double* const x, const unsigned int vecSize,
           const size_t varsCount, double* out);

/* PA: Return J_sqrtinv(x) */
void Jsqrtinv(const double* const x, const unsigned int vecSize,
              const size_t varsCount, double* out);
...
void Qxy(const double* const x, const double* const y,
         const unsigned int vecSize, const size_t varsCount, double* z);

/* Returns the product Q_{p}*z where p is the NT vector related to the pair
 * (x,y) */
void QNTpz(const double* const x, const double* const y, const double* const z,
           const unsigned int vecSize, const size_t varsCount, double* out);

/* Returns the product Q_{p^{-1}}*z where p is the NT vector related to the pair
 * (x,y) */
void QNTpinvz(const double* const x, const double* const y,
              const double* const z, const unsigned int vecSize,
              const size_t varsCount, double* out);

/* Returns the product Q_{p^{-2}}*z where p is the NT vector related to the pair
 * (x,y) */
void QNTpinv2z(const double* const x, const double* const y,
               const double* const z, const unsigned int vecSize,
               const size_t varsCount, double* out);

/* returns the Jordan product x^{-1} o y by using the formula x^{-1} =
 * R*x/det(x), where R is the reflection matrix */
void Jxinvprody(const double* const x, const double* const y,
                const unsigned int vecSize, const size_t varsCount,
                double* out);
...
/* Returns a long double as the square root of determinant of a vector related
...
*/
NumericsMatrix* NTmat(const double* const x, const double* const z,
                      const unsigned int vecSize, const size_t varsCount);
