...
\param tolerance threshold used to validate the computation: if the error is less than this
value, the computation is considered valid \return the conditioning
*/
