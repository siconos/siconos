 ...
 *   A[0][0] = a[0],  A[1][0] = a[1],  A[2][0] = a[2],  A[3][0] = a[3],  A[4][0] = a[4]  (column 0)
 *   A[0][1] = a[5],  A[1][1] = a[6],  A[2][1] = a[7],  A[3][1] = a[8],  A[4][1] = a[9]  (column 1)
 *   A[0][2] = a[10], A[1][2] = a[11], A[2][2] = a[12], A[3][2] = a[13], A[4][2] = a[14] (column 2)
 *   A[0][3] = a[15], A[1][3] = a[16], A[2][3] = a[17], A[3][3] = a[18], A[4][3] = a[19] (column 3)
 *   A[0][4] = a[20], A[1][4] = a[21], A[2][4] = a[22], A[3][4] = a[23], A[4][4] = a[24] (column 4)
 * 
