 ...
 * \return the leaving (or blocking) variable
 */
int pivot_selection_lemke2(unsigned n, double* col_drive, double* q_tilde, double* lexico_mat,
                           unsigned aux_indx, double lexico_tol);
 ...
 * \return the leaving (or blocking) variable
 */
int pivot_selection_lemke3(unsigned n, double* col_drive, double* q_tilde, double* lexico_col,
                           unsigned* basis, unsigned* candidate_indx,
                           SN_lumod_dense_data* lumod_data, unsigned aux_indx,
                           double lexico_tol);
 ...
 */
void init_M_lemke(double* mat, double* M, unsigned int dim, unsigned int size_x, double* q,
                  double* d);
 ...
 * \param q_tilde the modified q vector: it is the current of the variables currently in the
 * basis \param lexico_mat matrix for the lexicographic ordering \param col_drive column of the
 * driving variable \param col_tilde Solution to H x = col \param basis current basis \param
 * block the blocking or leaving variable \param drive the driving or entering variable
 */
void do_pivot_lumod(SN_lumod_dense_data* lumod_data, NumericsMatrix* M, double* q_tilde,
                    double* lexico_mat, double* col_drive, double* col_tilde, unsigned* basis,
