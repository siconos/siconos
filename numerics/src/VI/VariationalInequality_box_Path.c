...
static CB_FUNC(void) vi_box_PATH_bounds(void* restrict id, int n, double* restrict z,
...
static CB_FUNC(int)
    vi_box_PATH_jacobian_eval(void* id, int n, double* z, int wantf, double* f, int* nnz,
...
void vi_box_path(VariationalInequality* problem, double* z, double* F, int* info,
  ...
  SN_generic_path_env PATH_env = {n, nnz, z, F, box_set->lb, box_set->ub, problem};

  MCP_Interface mcp_interface = {&PATH_env,
                                 &PATH_problem_size,
                                 &vi_box_PATH_bounds,
                                 &vi_box_PATH_function_eval,
                                 &vi_box_PATH_jacobian_eval,
