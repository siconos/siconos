...
SICONOS_EXPORT void compute_nabla_F(void* problem, int n, double* restrict l,
...
SICONOS_EXPORT void compute_nabla_Fmcp(void* env, int n, double* restrict z,
                                       double* restrict nabla_Fmcp) {
  data* d = (data*)env;
  double l0 = 2.0 * z[0] - 1.0;
  double l1 = 2.0 * z[2] - 1.0;
  double invR = 1.0 / (1.0 - d->kappa * l0 * l1);
...
SICONOS_EXPORT void compute_nabla_Fmcp2(void* env, int n, double* restrict z,
                                        double* restrict nabla_Fmcp) {
  data* d = (data*)env;
  double l0 = 2.0 * z[0] - 1.0;
  double l1 = 2.0 * z[2] - 1.0;
