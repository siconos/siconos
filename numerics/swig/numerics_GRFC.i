...
// for b in GlobalRollingFrictionContact
...
%extend GlobalRollingFrictionContactProblem
{
  ...
  GlobalRollingFrictionContactProblem()
    {
      ...
      GlobalRollingFrictionContactProblem *FC = globalRollingFrictionContactProblem_new();
      // return pointer : free by std swig destructor
      return FC;
    }

  GlobalRollingFrictionContactProblem(SN_OBJ_TYPE *dim)
    {
  ...
  GlobalRollingFrictionContactProblem(SN_OBJ_TYPE *dim, SN_OBJ_TYPE *o1, SN_OBJ_TYPE *o2, SN_OBJ_TYPE *o3)
    {
