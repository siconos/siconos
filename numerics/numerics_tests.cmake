...
if(WITH_${COMPONENT}_TESTING)
  ...
  NEW_TEST(MCP_2_test_1 MCP_2_test1.c)
 END_TEST()

  BEGIN_TEST(src/NCP/test)
  SET(SICONOS_NCP_SOLVERS "NEWTON_FB_FBLSA;NEWTON_MIN_FBLSA;PATHSEARCH")
  IF(HAVE_PATHFERRIS)
  ...
  IF(NOT DEV_MODE)
    SET(NCP_NEWTON_FB_FBLSA-NCP_ZI1_PROPERTIES WILL_FAIL TRUE)
  ENDIF(NOT DEV_MODE)
  SET(NCP_NEWTON_FB_FBLSA-NCP_ZI1_TIMEOUT 60)
