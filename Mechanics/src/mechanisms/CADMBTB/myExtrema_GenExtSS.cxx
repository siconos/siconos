...
void myExtrema_GenExtSS::Initialize(const Adaptor3d_Surface& S2, 
				  const Standard_Integer NbU, 
				  const Standard_Integer NbV, 
...
void myExtrema_GenExtSS::Perform(const Adaptor3d_Surface& S1,
			       const Standard_Real    Tol1)
{
...
Standard_Boolean myExtrema_GenExtSS::IsDone() const 
{
  return myDone;
}
