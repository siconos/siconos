...
Standard_Boolean myExtrema_FuncExtSS::Value (const math_Vector& UV, 
					   math_Vector& F)
{
...
Standard_Boolean myExtrema_FuncExtSS::Derivatives (const math_Vector& UV, 
						 math_Matrix& Df)
{
  math_Vector F(1,4);
...
Standard_Boolean myExtrema_FuncExtSS::Values (const math_Vector& UV, 
					    math_Vector& F,
					    math_Matrix& Df)
{
...
Standard_Integer myExtrema_FuncExtSS::NbExt () const
{
