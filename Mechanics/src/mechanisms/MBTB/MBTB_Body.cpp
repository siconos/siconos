...
*
**/
MBTB_Body::MBTB_Body(SP::SiconosVector q0, SP::SiconosVector v0, double& mass,SP::SimpleMatrix I,SP::SiconosVector centerOfMass,
...
{
  setComputeFExtFunction(pluginLib,plunginFct);
