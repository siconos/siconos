...
*/
#include "DelayedSampledActuator.h"
...
DelayedSampledActuator::DelayedSampledActuator(int type, TimeDiscretisation* t): Actuator(type, t)
{}
...
void DelayedSampledActuator::initialize()
{
  ...
  this->addDynamicalSystemPtr(model->nonSmoothDynamicalSystem()->getDynamicalSystemPtr(0));
}
...
void DelayedSampledActuator::actuate()
{
  DSIterator itDS;
  SensorsIterator itS;
  int nDof = model->nonSmoothDynamicalSystem()->getDynamicalSystemPtr(0)->getDim();
  int ncont = 0;
