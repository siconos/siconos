...
const double R1 = 0.1; // beads1 radius
const double R2 = 0.1; // beads2 radius
const double m1 = 1; // beads1 mass
const double m2 = 1; // beads2 mass

// Momentum inertia
const double I1 = 3. / 5 * R1 * R1;
const double I2 = 3. / 5 * R2 * R2;


extern "C" void Mass1(unsigned int sizeOfq, const double *q, double *mass, double* param)
{
  mass[0]  = mass[7]  = mass[14] = m1;
  mass[21] = mass[28] = mass[35] = I1;
}

extern "C" void Mass2(unsigned int sizeOfq, const double *q, double *mass, double* param)
{
  mass[0]  = mass[7]  = mass[14] = m2;
  mass[21] = mass[28] = mass[35] = I2;
}
...
extern "C" void G0(unsigned int sizeOfq, const double* q, unsigned int sizeOfY, double* G, double* param)
{
  ...
  G[1] = G[5] = -1.;
  G[11] = R1 * (q[8] - q[2]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[13] = -R1 * (q[8] - q[2]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[16] =  R1 * (q[7] - q[1]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[17] =  -R1 * (q[6] - q[0]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));

  G[19] = G[23] = 1.;
  G[29] = R2 * (q[8] - q[2]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[31] = -R2 * (q[8] - q[2]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[34] =  R2 * (q[7] - q[1]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
  G[35] =  -R2 * (q[6] - q[0]) / sqrt((q[6] - q[0]) * (q[6] - q[0]) + (q[7] - q[1]) * (q[7] - q[1]) + (q[8] - q[2]) * (q[8] - q[2]));
