 ...
 *
 * 2 d.o.f simulation - 3D frictionl contact problem in presence of a rigid foundation
 *
...
#define WALL 0       // Positions of walls
...
void initSiconos()
{
  ...
  {
    cout << "Exception caught in \'sample/ Two_dof_oscillator Init\'" << endl;
  }
}
