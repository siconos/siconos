...
// in case of contact with cube inside of a cube

extern "C" void h0_b(unsigned int sizeOfq, const double* q, unsigned int sizeOfY, double* y, unsigned int sizeZ, double* param)
{
  y[0] = q[6] - q[2] - 0.9 - R;
}

extern "C" void G0_b(unsigned int sizeOfq, const double* q, unsigned int sizeOfY, double* G, unsigned int sizeZ, double* param)
{
