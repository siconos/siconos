...
int main(int argc, char* argv[])
{
  ...
  clock_t t1, t2, t3, t4, t5, t6, t7, t6i, t7i;
  t1 = clock();
  ...
  try
  {
    ...
    t2 = clock();
    cout << "Computation Time1: " << (t2 - t1) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    t3 = clock();
    cout << "Computation Time2: " << (t3 - t2) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    t4 = clock();
    cout << "Computation Time3: " << (t4 - t3) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    t5 = clock();
    cout << "Computation Time4: " << (t5 - t4) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    t6 = clock();
    cout << "Computation Time5: " << (t6 - t5) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    for (iter_k = 1 ; iter_k < N + 1  ; ++iter_k)
    {
      ...
      t7i = clock();
      cout << "Computation Time6(" << iter_k << " ): " << (t7i - t6i) / (double)CLOCKS_PER_SEC << endl << endl;
    ...
    t7 = clock();
    cout << "Computation Time6: " << (t7 - t6) / (double)CLOCKS_PER_SEC << endl << endl;
