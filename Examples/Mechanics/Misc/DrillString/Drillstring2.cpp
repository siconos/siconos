/* Siconos-Samples version 2.1.1, Copyright INRIA 2005-2007.
...
int main(int argc, char* argv[])
{
  try
  {
    ...
    Model oscillator("./Drillstring2.xml");
    ...
    dataPlot(k, 2) = (oscillo->getQ())(1);
    // velocity for the oscillo
    dataPlot(k, 3) = (oscillo->getVelocity())(0);
    dataPlot(k, 4) = (oscillo->getVelocity())(1);
    //dataPlot(k, 4) = (oscillator.getNonSmoothDynamicalSystemPtr()->getInteractionPtr(0)->getLambda(1))(0);
    //dataPlot(k, 4) = (oscillator.getNonSmoothDynamicalSystemPtr()->getInteractionPtr(0)->getLambda(1))(1);

    dataPlot(k, 5) = (oscillo->getQ())(2);
    dataPlot(k, 6) = (oscillo->getQ())(3);
