...
#ifdef CLSC_CIRCUIT
  //  workX.setValue(0,0);
  lambda.setValue(0, 20.0 / (sR2 + sR1s));
  lambda.setValue(1, -20.0 / (sR2 + sR1d));
  lambda.setValue(2, 20 - 20 * ((sR1s) / (sR2 + sR1s)));
  lambda.setValue(3, 0);
  lambda.setValue(4, sE_plus);
  lambda.setValue(5, 0);
  lambda.setValue(6, 0);
  lambda.setValue(7, 20 - 20 * ((sR1s) / (sR2 + sR1s)));
  lambda.setValue(8, sR2 - sR1d);
  y.setValue(0, 0);
  y.setValue(1, 0);
  y.setValue(2, 0);
  y.setValue(3, 0);
