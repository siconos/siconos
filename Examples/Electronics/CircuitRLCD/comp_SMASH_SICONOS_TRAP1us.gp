...
#      of the CircuitRLCD circuit with trapezoidal
...
#    - results from SICONOS  "CircuitRLCDTRAP1us.dat" (rename of "CircuitRLCD.dat")
...
plot\
  ...
  "CircuitRLCDTRAP1us.dat" u 1:2 t      "capacitor voltage , SICONOS TRAP 1us" w l 
set origin 0.0,winheight*2.0+heightoff
set ylabel "A" 1
plot\
  "SMASHN0p25TRAP1us.dat" u ($1-toffset):3 t "inductor current , SMASH   TRAP 1us" w l,\
  "CircuitRLCDTRAP1us.dat" u 1:3 t      "inductor current , SICONOS TRAP 1us" w l
set origin 0.0,winheight+heightoff
set ylabel "V" 1
plot\
  "SMASHN0p25TRAP1us.dat" u ($1-toffset):4 t "diode voltage , SMASH   TRAP 1us" w l,\
  "CircuitRLCDTRAP1us.dat" u 1:4 t      "diode voltage , SICONOS TRAP 1us" w l
...
set ylabel "A" 1
plot\
  "SMASHN0p25TRAP1us.dat" u ($1-toffset):5 t "diode current , SMASH   TRAP 1us" w l,\
  "CircuitRLCDTRAP1us.dat" u 1:5 t      "diode current , SICONOS TRAP 1us" w l
set nomultiplot
