...
set ylabel "V"
plot\
  "Diodebridge-stdhalf.dat" u ($1-toffset):2 t "capacitor voltage , STD HALF   TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:2 t           "capacitor voltage , SICONOS TRAP 1us" w l 
set origin 0.0,winheight*2.0+heightoff
set ylabel "A"
plot\
  "Diodebridge-stdhalf.dat" u ($1-toffset):3 t "inductor current , STD HALF   TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:3 t           "inductor current , SICONOS TRAP 1us" w l
set origin 0.0,winheight+heightoff
set ylabel "V"
plot\
  "Diodebridge-stdhalf.dat" u ($1-toffset):(-$5) t  "diode R1 cathod pot. , STD HALF   TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:(-($5)) t      "diode R1 cathod pot. , SICONOS TRAP 1us" w l,\
  "Diodebridge-stdhalf.dat" u ($1-toffset):6 t  "diode F2 anode pot. ,  STD HALF   TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:6 t            "diode F2 anode pot. ,  SICONOS TRAP 1us" w l
...
set ylabel "A"
plot\
  "Diodebridge-stdhalf.dat" u ($1-toffset):($4+$7) t  "resistor current , STD HALF   TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:($4 + $7) t    "resistor current , SICONOS TRAP 1us" w l
set nomultiplot
...
set yrange [0:5.1e-5]
plot\
  "DiodeBridge.dat" u 1:($8) t    "storage, SICONOS TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:($9) t    "dissipation, SICONOS TRAP 1us" w l,\
  "DiodeBridge.dat" u 1:($10) t    "total, SICONOS TRAP 1us" w l
