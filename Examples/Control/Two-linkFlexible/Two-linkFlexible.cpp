...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    q0(2) = 0.9;
    q0(3) = -1.6;
    SiconosVector * z = new SimpleVector(nDof * 4 + 2);
    (*z)(0) = q0(0);
    (*z)(1) = q0(1);
    (*z)(2) = v0(0);
    (*z)(3) = v0(1);
    ...
    // -- OneStepIntegrators --
    OneStepIntegrator * OSI =  new Moreau(arm, 0.50001, s);
    ...
    dataPlot(k, 10) = test;
    dataPlot(k, 11) = (*p)(1);
    dataPlot(k, 12) = 0.5 * cos((*z)(14)) + 0.5 * cos((*z)(14) + (*z)(15));
    dataPlot(k, 13) = 0.5 * sin((*z)(14)) + 0.5 * sin((*z)(14) + (*z)(15));
    ...
    while (k < N)
    {
      ...
      if ((dataPlot(k, 3) <= 0.01) && (test == 0) && (dataPlot(k, 6) < 0.6))
      {
        ...
        (*z)(7) = (*z)(9);
        arm->setComputeFExtFunction("Two-linkFlexiblePlugin.so", "U10");
        test = 1;
      }
      ...
      {
        (*z)(8) = dataPlot(k, 0);
        arm->setComputeFExtFunction("Two-linkFlexiblePlugin.so", "U11");
        test = 2;
      }
      ...
      if ((dataPlot(k, 11) > 0) && (test == 2) && (dataPlot(k, 7) - dataPlot(k - 1, 7) == 1)) // && (fabs((inter->getY(1))(1))<1e-8))
      {
        L = dataPlot(k, 0) - (*z)(8);
        (*z)(8) = dataPlot(k, 0);
        arm->setComputeFExtFunction("Two-linkFlexiblePlugin.so", "U2");
        test = 3;
        nimpact = 0;
      }
      ...
      if ((trunc((dataPlot(k, 0) + h) / (*z)(11)) > trunc((dataPlot(k, 0)) / (*z)(11))) && (test == 3))
      {
        (*z)(10) = dataPlot(k, 0) + h;
        (*z)(8) = (*z)(12);
        arm->setComputeFExtFunction("Two-linkFlexiblePlugin.so", "U3");
        test = 4;
        L = 0;
      }
...
//     // -- OneStepNsProblem --
//     OneStepNSProblem * osnspb = new LCP(s,"name","Lemke",200001, 1e-7);
...
// // controller during constraint-motion phase.
//  if((fabs((inter->getY(1))(1))<=1e-5) && (test==2) && ((inter->getY(0))(1)<=1e-6))
//    {
//      (*z)(8) = dataPlot(k,0);
//      arm->setComputeFExtFunction("Two-linkFlexiblePlugin.so","U2");
//      test = 3;
