...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    relayOscillatorWithChattering->setNonSmoothDynamicalSystemPtr(myNSDS); // set NonSmoothDynamicalSystem of this model
    ...
    relayOscillatorWithChattering->initialize(s);
