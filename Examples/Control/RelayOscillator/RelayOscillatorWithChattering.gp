...
resultfile="RelayOscillatorWithChattering.dat"

set autoscale
set ticslevel 0
set output "RelayOscillatorWithChattering-phase".extension
set view 60,240
set grid
set zlabel "x1"
set ylabel "x2"
...
set output "RelayOscillatorWithChattering".extension
set multiplot
