...
if(FORCE_SKIP_RPATH) # Build with no RPATH. Do we really need this option??
  ...
  set(CMAKE_SKIP_BUILD_RPATH FALSE) # --> always use RPATH during build
endif()
...
# entries to add to binaries linked in the build tree
set(CMAKE_BUILD_RPATH)
foreach(comp IN LISTS COMPONENTS)
  list(APPEND CMAKE_BUILD_RPATH "${CMAKE_BINARY_DIR}/${comp}")
endforeach()
