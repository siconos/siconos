...
IF(MUMPS_LIBRARY_DIRECTORY AND NOT _MUMPS_DEFAULT_SEARCH_DIR)
  FIND_LIBRARY(MUMPS_COMMON_LIBRARY ${__MUMPS_COMMON_NAMES} PATHS "${MUMPS_LIBRARY_DIRECTORY}" NO_DEFAULT_PATH)
ELSE()
  FIND_LIBRARY(MUMPS_COMMON_LIBRARY ${__MUMPS_COMMON_NAMES})
ENDIF()

IF(MUMPS_LIBRARY_DIRECTORY)
  FIND_LIBRARY(METIS_LIBRARY ptscotch PATHS "${MUMPS_LIBRARY_DIRECTORY}" NO_DEFAULT_PATH)
  IF(NOT METIS_LIBRARY)
    FIND_LIBRARY(METIS_LIBRARY ptscotch)
  ENDIF()
ELSE(MUMPS_LIBRARY_DIRECTORY)
  FIND_LIBRARY(METIS_LIBRARY ptscotch)
ENDIF(MUMPS_LIBRARY_DIRECTORY)
...
IF(MUMPS_LIBRARY_DIRECTORY)
  FIND_LIBRARY(METIS_LIBRARY scotch PATHS "${MUMPS_LIBRARY_DIRECTORY}" NO_DEFAULT_PATH)
  IF(NOT METIS_LIBRARY)
    FIND_LIBRARY(METIS_LIBRARY scotch)
  ENDIF()
ELSE(MUMPS_LIBRARY_DIRECTORY)
  FIND_LIBRARY(METIS_LIBRARY scotch)
ENDIF(MUMPS_LIBRARY_DIRECTORY)
