...
/**
   ...
   Note that the polyhedral set \f$ P \f$ is described as \f$ \{\lambda\mid H \lambda \geq K\}
   \f$, where \f$ H \f$ is a matrix and \f$ K \f$ a vector.
...
class NormalConeNSL : public NonSmoothLaw {
 ...
 public:
   ...
   */
  inline siconos::algebra::SiconosVector& K() { return *_K; };
