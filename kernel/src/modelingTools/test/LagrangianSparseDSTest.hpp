...
class LagrangianSparseDSTest : public CppUnit::TestFixture {
 private:
  ...
  CPPUNIT_TEST(testBuildLagrangianSparseDS1);
  CPPUNIT_TEST(testBuildLagrangianSparseDS2);
  CPPUNIT_TEST(testBuildLagrangianSparseDS3);
  CPPUNIT_TEST_SUITE_END();

  // \todo exception test

  void testBuildLagrangianSparseDS1();
  void testBuildLagrangianSparseDS2();
  void testBuildLagrangianSparseDS3();
  // void testcomputeDS();
