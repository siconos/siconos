...
void LagrangianLinearTIDSTest::setUp()
{
  ...
  invM.reset(new SimpleMatrix(3,3));
  (*invM)(0,0) = -1.; (*invM)(1,1) = -0.5; (*invM)(2,2) = -1./3;
  prod(*invM, *K, *rhsK, true);
  prod(*invM, *C, *rhsC, true);
}
...
void LagrangianLinearTIDSTest::testBuildLagrangianLinearTIDS1()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testBuildLagrangianLinearTIDS1 : ", ds->jacobianqForces() == NULL, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testBuildLagrangianLinearTIDS1 : ", ds->jacobianqDotForces() == NULL, true);
