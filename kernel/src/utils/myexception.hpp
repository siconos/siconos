...
namespace Siconos
{
  namespace exception
  {
    ...
    typedef boost::error_info<struct message,const char *> extra_message;
     ...
     */
    struct My : virtual std::exception, virtual boost::exception {};
    struct Matrix : virtual My {};
    ...
    */
    ...
    /**
     ...
     Must be called inside a catch section.
    */
    static inline void process(Siconos::exception::My& e)
      {
...
#define THROW_EXCEPTION(X) BOOST_THROW_EXCEPTION(Siconos::exception::My() << Siconos::exception::extra_message(X) << Siconos::exception::errno_code(errno) <<Siconos::exception::errno_description(std::strerror(errno)));
