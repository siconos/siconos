...
void siconos::algebra::concatenateVectors(siconos::algebra::SiconosVector& target, const siconos::algebra::SiconosVector& a, const siconos::algebra::SiconosVector& b){
