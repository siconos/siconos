...
void siconos::algebra::setBlock(const SiconosMatrix &input_matrix,
  ...
  if (numOut == UblasType::ZERO ||
      numOut == UblasType::IDENTITY)  // if output_matrix = 0 or Identity => read-only
