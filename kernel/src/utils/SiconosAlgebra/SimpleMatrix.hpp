...
class SimpleMatrix : public SiconosMatrix {
 ...
 public:
   ...
   * col:end)
   */
  SimpleMatrix(const SimpleMatrix& A, const std::vector<std::size_t>& coord);
  ...
  inline std::shared_ptr<VInt> ipiv() const { return _ipiv; }
   ...
   *  \param vIn column
   */
  void normInfByColumn(std::shared_ptr<SiconosVector> vIn) const;
  ...
  */
   ...
   *  \param[in,out] vOut the expected column
   */
   ...
   *  \param[in,out] vOut the expected row
   */
  void getSubRow(unsigned int index, unsigned int pos,
                 std::shared_ptr<SiconosVector> vOut) const;
   ...
   *  \param vIn a vector
   */
  void setSubCol(unsigned int index, unsigned int pos, std::shared_ptr<SiconosVector> vIn);
   ...
   *  \param vIn a vector
   */
  void setSubRow(unsigned int index, unsigned int pos, std::shared_ptr<SiconosVector> vIn);
  ...
  */
  ...
  friend void operator+=(std::shared_ptr<SiconosMatrix>, std::shared_ptr<SimpleMatrix>);
