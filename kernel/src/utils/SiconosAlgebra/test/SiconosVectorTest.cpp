...
void SiconosVectorTest::testConstructor0()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
  for (unsigned int i = 0; i < v->size(); i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", (*v)(i) == 0, true);
  v = std::make_shared<SiconosVector>(4, siconos::algebra::UBLAS_TYPE::SPARSE);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", v->size() == 4, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testConstructor1()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
  for (unsigned int i = 0; i < v->size(); i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", (*v)(i) == 2.4, true);
  v = std::make_shared<SiconosVector>(3, 2.4, siconos::algebra::UBLAS_TYPE::SPARSE);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", v->size() == 3, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testConstructor3()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
  tmp = std::make_shared<SiconosVector>(4, siconos::algebra::UBLAS_TYPE::SPARSE);
  v = std::make_shared<SiconosVector>(*tmp);

  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", v->size() == 4, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", *v == *tmp, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testConstructor4()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor4 : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
...
void SiconosVectorTest::testConstructor5()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor5 : ", norm_inf(*v->sparse() - *sv) < tol,
                               true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor5 : ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testConstructor6()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor6 : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
...
void SiconosVectorTest::testConstructor7()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("init from block: ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testResize()
{
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("test resize : ", v->num() == siconos::algebra::UBLAS_TYPE::DENSE, true);
...
void SiconosVectorTest::testOperators2()
{
  ...
  *z /= 2.0;
  ...
  // sparse += -= sparse
  auto v = std::make_shared<SiconosVector>(5, siconos::algebra::UBLAS_TYPE::SPARSE);
  *v += *w;
  ...
  *v -= *w;
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", norm_inf(*v->sparse() - 2 * *sv) < tol,
                               true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", v->num() == siconos::algebra::UBLAS_TYPE::SPARSE, true);
...
void SiconosVectorTest::testOperators4()
{
  ...
  *z = a * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - a * *x->dense()) < tol, true);
  z->zero();
  *z = *x * a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - a * *x->dense()) < tol, true);
  ...
  *z = a1 * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - a1 * *x->dense()) < tol, true);
  z->zero();
  *z = *x * a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - a1 * *x->dense()) < tol, true);
  ...
  *z = *x / a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - *x->dense() / a) < tol, true);
  z->zero();
  *z = *x / a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->dense() - *x->dense() / a1) < tol, true);
  z->zero();

  //  sparse = a*sparse or sparse/a
  x = std::make_shared<SiconosVector>(*sv);
  z = std::make_shared<SiconosVector>(size, siconos::algebra::UBLAS_TYPE::SPARSE);
  *z = a * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  z->zero();
  *z = *x * a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  ...
  *z = a1 * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->sparse() - a1 * *x->sparse()) < tol, true);
  z->zero();
  *z = *x * a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", norm_2(*z->sparse() - a1 * *x->sparse()) < tol, true);
  ...
  //   ",norm_2(*z->sparse()-*x->sparse()/a)<tol, true); z->zero(); *z = (*x)/a1; //
  //   CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 :
  //   ",norm_2(*z->sparse()-*x->sparse()/a1)<tol, true);
...
void SiconosVectorTest::testOperators4Bis()
{
  ...
  scal(a, *x, *z);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", norm_2(*z->dense() - a * *x->dense()) < tol, true);
  z->zero();
  scal(1.0 / a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", norm_2(*z->dense() - *x->dense() / a) < tol, true);
  z->zero();
  ...
  scal(a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  z->zero();
  // Following tests failed. Sparse init pb. To be reviewed.
  scal(1.0 / a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", norm_2(*z->sparse() - *x->sparse() / a) < tol, true);
...
void SiconosVectorTest::testOperators4Ter()
{
  ...
  scal(a, *x, *z, false);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", norm_2(*z->dense() - a * *x->dense()) < tol, true);
  scal(a, *x, *z, false);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", norm_2(*z->dense() - 2 * a * *x->dense()) < tol, true);
  ...
  scal(a, *x, *z, false);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", norm_2(*z->sparse() - 2 * a * *x->sparse()) < tol, true);
...
void SiconosVectorTest::testSubscal()
{
  ...
  //
  // xx sparse, ys dense
  xx = std::make_shared<SiconosVector>(size, siconos::algebra::UBLAS_TYPE::SPARSE);
  xx->fill(2.0);
  *yref = *ys;
  subscal(a, *xx, *ys, coord, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(4) - a * (*xx)(1)) < tol, true);
  ...
  // xx sparse, ys sparse
  ys = std::make_shared<SiconosVector>(size, siconos::algebra::UBLAS_TYPE::SPARSE);
  *yref = *ys;
  subscal(a, *xx, *ys, coord, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(4) - a * (*xx)(1)) < tol, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(5) - a * (*xx)(2)) < tol, true);
