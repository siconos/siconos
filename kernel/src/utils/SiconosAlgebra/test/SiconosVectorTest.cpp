...
void SiconosVectorTest::testConstructor0() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor0 : ", v->num() == siconos::algebra::UblasType::DENSE, true);
  for (unsigned int i = 0; i < v->size(); i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", (*v)(i) == 0, true);
  v = std::make_shared<SiconosVector>(4, siconos::algebra::UblasType::SPARSE);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor0 : ", v->size() == 4, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor0 : ", v->num() == siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testConstructor1() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor1 : ", v->num() == siconos::algebra::UblasType::DENSE, true);
  for (unsigned int i = 0; i < v->size(); i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", (*v)(i) == 2.4, true);
  v = std::make_shared<SiconosVector>(3, 2.4, siconos::algebra::UblasType::SPARSE);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor1 : ", v->size() == 3, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor1 : ", v->num() == siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testConstructor3() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor3 : ", v->num() == siconos::algebra::UblasType::DENSE, true);
  tmp = std::make_shared<SiconosVector>(4, siconos::algebra::UblasType::SPARSE);
  v = std::make_shared<SiconosVector>(*tmp);

  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", v->size() == 4, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor3 : ", *v == *tmp, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor3 : ", v->num() == siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testConstructor4() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor4 : ", v->num() == siconos::algebra::UblasType::DENSE, true);
...
void SiconosVectorTest::testConstructor5() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testConstructor5 : ", norm_inf(*v->sparse() - *sv) < tol,
                               true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor5 : ", v->num() == siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testConstructor6() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testConstructor6 : ", v->num() == siconos::algebra::UblasType::DENSE, true);
...
void SiconosVectorTest::testConstructor7() {
  ...
  // CPPUNIT_ASSERT_EQUAL_MESSAGE("init from block: ", v->num() ==
  // siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testNorm() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testNorm : ", (v->norm2() - ublas::norm_2(*dv)) < tol, true);
...
void SiconosVectorTest::testResize() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "test resize : ", v->num() == siconos::algebra::UblasType::DENSE, true);
...
void SiconosVectorTest::testSetBlockFriend() {
  ...
  auto subBlock = std::make_shared<SiconosVector>(6);
  unsigned int posIn = 1;
  unsigned int posOut = 3;
  siconos::algebra::setBlock(*ref, subBlock, sizeB, posIn, posOut);

  for (unsigned int i = posOut; i < sizeB; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("test setBlock : ", (*subBlock)(i) == (*ref)(i + posIn),
                                 true);
...
void SiconosVectorTest::testAssignment() {
  ...
  *v = *w;
  ...
  auto w2 = std::make_shared<SiconosVector>(vq);
  *v = *w2;
  for (unsigned int i = 0; i < vq.size(); i++)
...
void SiconosVectorTest::testOperators2() {
  ...
  *z *= a;
  for (unsigned int i = 0; i < size; i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", fabs((*z)(i)-2 * a * (*x)(i)) < tol,
                                 true);
  *z *= a1;
  for (unsigned int i = 0; i < size; i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", fabs((*z)(i)-2 * a1 * a * (*x)(i)) < tol,
                                 true);
  *z /= a1;
  for (unsigned int i = 0; i < size; i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", fabs((*z)(i)-2 * a * (*x)(i)) < tol,
  ...
  *z += *x;
  ...
  //  *z+=*xB;
  //  for (unsigned int i=0; i< size; i++)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ",fabs((*z)(i)-(*x)(i)-(*xB)(i))<tol,
  //    true);
  //  *z-=*xB;
  //  for (unsigned int i=0; i< size; i++)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ",fabs((*z)(i)-(*x)(i))<tol, true);
  //
  // dense +=, -=, ... sparse
  auto w = std::make_shared<SiconosVector>(*sv);
  z->zero();
  *z += *w;
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", norm_inf(*z->dense() - *w->sparse()) < tol,
                               true);
  *z *= 3;
  *z -= *w;
  for (unsigned int i = 0; i < size; i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "testOperators2 : ", norm_inf(*z->dense() - 2 * *w->sparse()) < tol, true);
  *z /= 2.0;
  for (unsigned int i = 0; i < size; i++)
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "testOperators2 : ", norm_inf(*z->dense() - *w->sparse()) < tol, true);

  // sparse += -= sparse
  auto v = std::make_shared<SiconosVector>(5, siconos::algebra::UblasType::SPARSE);
  *v += *w;
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", norm_inf(*v->sparse() - *sv) < tol, true);
  *v *= 3;
  *v -= *w;
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators2 : ", norm_inf(*v->sparse() - 2 * *sv) < tol,
                               true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators2 : ", v->num() == siconos::algebra::UblasType::SPARSE, true);
...
void SiconosVectorTest::testOperators3() {
  ...
  double res;
  // *
  res = siconos::algebra::inner_prod(*v, *w);  // dense*dense
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators3 : ", res == 55, true);
  w = std::make_shared<SiconosVector>(*sv);
  res = siconos::algebra::inner_prod(*v, *w);  // dense*sparse
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators3 : ", res == 44, true);
  v = std::make_shared<SiconosVector>(*sv);
  res = siconos::algebra::inner_prod(*v, *w);  // sparse*sparse
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators3 : ", res == 484, true);
  w = std::make_shared<SiconosVector>(vq);
  res = siconos::algebra::inner_prod(*v, *w);  // sparse*dense
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators3 : ", res == 44, true);
...
void SiconosVectorTest::testOperators4() {
  ...
  *z = a * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - a * *x->dense()) < tol, true);
  z->zero();
  *z = *x * a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - a * *x->dense()) < tol, true);
  ...
  *z = a1 * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - a1 * *x->dense()) < tol, true);
  z->zero();
  *z = *x * a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - a1 * *x->dense()) < tol, true);
  ...
  *z = *x / a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - *x->dense() / a) < tol, true);
  z->zero();
  *z = *x / a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->dense() - *x->dense() / a1) < tol, true);
  z->zero();

  //  sparse = a*sparse or sparse/a
  x = std::make_shared<SiconosVector>(*sv);
  z = std::make_shared<SiconosVector>(size, siconos::algebra::UblasType::SPARSE);
  *z = a * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  z->zero();
  *z = *x * a;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  ...
  *z = a1 * *x;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->sparse() - a1 * *x->sparse()) < tol, true);
  z->zero();
  *z = *x * a1;  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4 : ", ublas::norm_2(*z->sparse() - a1 * *x->sparse()) < tol, true);
  ...
  //   *z = (*x)/a; //
  //   CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 :
  //   ",ublas::norm_2(*z->sparse()-*x->sparse()/a)<tol, true); z->zero(); *z = (*x)/a1; //
  //   CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 :
  //   ",ublas::norm_2(*z->sparse()-*x->sparse()/a1)<tol, true);

  // simple = a * block
  z = std::make_shared<SiconosVector>(size);
  //  *z = a**xB; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*z)(i) - (a*(*xB)(i)))<tol,
  //    true);
  //  z->zero();
  //  *z = *xB*a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  ...
  //  *z = a1**xB; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*z)(i) - (a1*(*xB)(i)))<tol,
  //    true);
  //
  //  z->zero();
  //  *z = *xB*a1; //
  ...
  //  *z = (*xB)/a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ",fabs((*z)(i) -((*xB)(i)/a))< tol,
  //    true);
  //
  //  z->zero();
  //  *z = (*xB)/a1; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*z)(i) - ((*xB)(i)/a1))< tol,
  //    true);
  //
  //  // x block, z block
  //
  //  *zB = a**xB; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - (a*(*xB)(i)))< tol,
  //    true);
  //  zB->zero();
  //  *zB = *xB*a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  ...
  //  *zB = a1**xB; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - (a1*(*xB)(i)))< tol,
  //    true);
  //
  //  zB->zero();
  //  *zB = *xB*a1; //
  ...
  //  *zB = *xB/a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - ((*xB)(i)/a))< tol,
  //    true);
  //
  //  zB->zero();
  //  *zB = *xB/a1; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - ((*xB)(i)/a1))< tol,
  //    true);
  //
  //  x= std::make_shared<SiconosVector>(vq));
  //
  ...
  //  *zB = a**x; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - (a*(*x)(i)))< tol,
  //    true);
  //  zB->zero();
  //  *zB = *x*a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  ...
  //  *zB = a1**x; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - (a1*(*x)(i)))< tol,
  //    true);
  //
  //  zB->zero();
  //  *zB = *x*a1; //
  ...
  //  *zB = *x/a; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - ((*x)(i)/a))< tol,
  //    true);
  //
  //  zB->zero();
  //  *zB = *x/a1; //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4 : ", fabs((*zB)(i) - ((*x)(i)/a1))< tol,
  //    true);
  //
  //  zB->zero();
...
void SiconosVectorTest::testOperators4Bis() {
  ...
  scal(a, *x, *z);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", ublas::norm_2(*z->dense() - a * *x->dense()) < tol, true);
  z->zero();
  scal(1.0 / a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", ublas::norm_2(*z->dense() - *x->dense() / a) < tol, true);
  z->zero();
  ...
  scal(a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", ublas::norm_2(*z->sparse() - a * *x->sparse()) < tol, true);
  z->zero();
  // Following tests failed. Sparse init pb. To be reviewed.
  scal(1.0 / a, *x, *z);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Bis : ", ublas::norm_2(*z->sparse() - *x->sparse() / a) < tol, true);

  // simple = a * block
  z = std::make_shared<SiconosVector>(size);
  //  scal(a,*xB,*z); //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ", fabs((*z)(i) - (a*(*xB)(i)))<tol,
  //    true);
  //  z->zero();
  //  scal(1.0/a, *xB, *z);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ",fabs((*z)(i) -((*xB)(i)/a))< tol,
  //    true);
  //
  // x block, z block
  ...
  //  scal(a, *xB, *zB);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ", fabs((*zB)(i) - (a*(*xB)(i)))<
  //    tol, true);
  //  zB->zero();
  //  scal(1.0/a, *xB, *zB);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ", fabs((*zB)(i) - ((*xB)(i)/a))<
  //    tol, true);
  //
  //  x= std::make_shared<SiconosVector>(vq);
  //
  ...
  //  scal(a,*x,*zB);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ", fabs((*zB)(i) - (a*(*x)(i)))< tol,
  //    true);
  //  zB->zero();
  //  scal(1.0/a, *x, *zB);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Bis : ", fabs((*zB)(i) - ((*x)(i)/a))< tol,
  //    true);
  //  zB->zero();
...
void SiconosVectorTest::testOperators4Ter() {
  ...
  scal(a, *x, *z, false);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", ublas::norm_2(*z->dense() - a * *x->dense()) < tol, true);
  scal(a, *x, *z, false);  //
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", ublas::norm_2(*z->dense() - 2 * a * *x->dense()) < tol, true);
  ...
  scal(a, *x, *z, false);
  CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "testOperators4Ter : ", ublas::norm_2(*z->sparse() - 2 * a * *x->sparse()) < tol, true);
  ...
  //
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Ter : ", fabs((*z)(i) -
  //    2*(a*(*xB)(i)))<tol, true);
  //  z->zero();
  //  // x block, z block
  //
  ...
  //  scal(a, *xB, *zB,false);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Ter : ", fabs((*zB)(i) - 2*(a*(*xB)(i)))<
  //    tol, true);
  //
  //  x= std::make_shared<SiconosVector>(vq);
  //
  ...
  //  scal(a,*x,*zB, false);
  //  for (unsigned int i = 0; i< size ; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators4Ter : ", fabs((*zB)(i) - 2*(a*(*x)(i)))<
  //    tol, true);
  //  zB->zero();
...
void SiconosVectorTest::testOperators5() {
  ...
  *z = *x + *y;
  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5 : ", fabs((*z)(i) - (*x)(i) - (*y)(i)) < tol,
                                 true);
  z->zero();
  // Simple = Simple + Block, all dense
  //  *z = *x + *yB ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5 : ", fabs((*z)(i) - (*x)(i) -
  //    (*yB)(i))<tol , true);
  //
  //  z->zero();
  ...
  //  *z = *xB + *y ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5 : ", fabs((*z)(i) - (*xB)(i) -
  //    (*y)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block + Block
  ...
  //  *zB = *x + *y ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5 : ", fabs((*zB)(i) - (*x)(i) -
  //    (*y)(i))<tol , true);
  //  zB->zero();
  ...
  //  *zB = *xB + *y ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5 : ", fabs((*zB)(i) - (*xB)(i) -
  //    (*y)(i))<tol , true);
  //
  //  zB->zero();
  //  // Block = Block + Block
...
void SiconosVectorTest::testOperators5Bis() {
  ...
  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "testOperators5Bis : ", fabs((*z)(i) - (*x)(i) - (*y)(i)) < tol, true);
  z->zero();
  // Simple = Simple + Block, all dense
  //  add(*x,*yB,*z);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5Bis : ", fabs((*z)(i) - (*x)(i) -
  //    (*yB)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block + Simple, all dense
  //  add(*xB,*y,*z);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5Bis : ", fabs((*z)(i) - (*xB)(i) -
  //    (*y)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block + Block
  ...
  //  add(*x,*y,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5Bis : ", fabs((*zB)(i) - (*x)(i) -
  //    (*y)(i))<tol , true);
  //  zB->zero();
  //  // Block = Simple + Block, all dense
  //  add(*x,*yB,*zB);
  ...
  //  add(*xB,*y,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators5Bis : ", fabs((*zB)(i) - (*xB)(i) -
  //    (*y)(i))<tol , true);
  //
  //  zB->zero();
  //  // Block = Block + Block
...
void SiconosVectorTest::testOperators6() {
  ...
  *z = *x - *y;
  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*z)(i) - (*x)(i) + (*y)(i)) < tol,
                                 true);
  z->zero();
  // Simple = Simple - Block, all dense
  //  *z = *x - *yB ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*z)(i) - (*x)(i) +
  //    (*yB)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block - Simple, all dense
  //  *z = *xB - *y ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*z)(i) - (*xB)(i) +
  //    (*y)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block - Block
  ...
  *zB = *x - *y;
  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*zB)(i) - (*x)(i) + (*y)(i)) < tol,
                                 true);
  zB->zero();
  // Block = Simple - Block, all dense
  //  *zB = *x - *yB ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*zB)(i) - (*x)(i) +
  //    (*yB)(i))<tol , true);
  //
  //  zB->zero();
  //  // Block = Block - Simple, all dense
  //  *zB = *xB - *y ;
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6 : ", fabs((*zB)(i) - (*xB)(i) +
  //    (*y)(i))<tol , true);
  //
  //  zB->zero();
  //  // Block = Block - Block
...
void SiconosVectorTest::testOperators6Bis() {
  ...
  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "testOperators6Bis : ", fabs((*z)(i) - (*x)(i) + (*y)(i)) < tol, true);
  z->zero();
  // Simple = Simple - Block, all dense
  //  sub(*x,*yB,*z);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6Bis : ", fabs((*z)(i) - (*x)(i) +
  //    (*yB)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block - Simple, all dense
  //  sub(*xB,*y,*z);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6Bis : ", fabs((*z)(i) - (*xB)(i) +
  //    (*y)(i))<tol , true);
  //
  //  z->zero();
  //  // Simple = Block - Block
  ...
  //  sub(*x,*y,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6Bis : ", fabs((*zB)(i) - (*x)(i) +
  //    (*y)(i))<tol , true);
  //  zB->zero();
  //  // Block = Simple - Block, all dense
  //  sub(*x,*yB,*zB);
  ...
  //  sub(*xB,*y,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators6Bis : ", fabs((*zB)(i) - (*xB)(i) +
  //    (*y)(i))<tol , true);
  //
  //  zB->zero();
  //  // Block = Block - Block
...
void SiconosVectorTest::testOperators7() {
  ...
  // z Simple ,  x Simple
  auto tmp = std::make_shared<SiconosVector>(*z);  // copy of z for comparison.
  axpy(a, *x, *z);

  for (unsigned int i = 0; i < size; ++i)
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
        "testOperators7 : ", fabs((*z)(i)-a * (*x)(i) - (*tmp)(i)) < tol, true);
  z->zero();
  //  z Simple ,  x Block
  //  axpy(a, *xB,*z);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators7 : ", fabs((*z)(i) - a*(*xB)(i) +
  //    (*tmp)(i))<tol , true);
  //
  //  z->zero();
  //  zB->zero();
  //  // z Block, x Simple
  //  tmp= std::make_shared<SiconosVector>(*zB);
  //  axpy(a,*x,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators7 : ", fabs((*zB)(i) - a*(*x)(i) +
  //    (*tmp)(i))<tol , true);
  //
  //  zB->zero();
  //  // y and x Block
  //  axpy(a, *xB,*zB);
  //  for (unsigned int i = 0; i<size; ++i)
  //    CPPUNIT_ASSERT_EQUAL_MESSAGE("testOperators7 : ", fabs((*zB)(i) - a*(*xB)(i) +
  //    (*tmp)(i))<tol , true);
  //
  //  zB->zero();
  //
...
void SiconosVectorTest::testOperators8() {
  ...
  *res = siconos::algebra::outer_prod(*tmp1, *x);  // dense*dense
  ...
  for (unsigned int i = 0; i < size1; ++i)
    for (unsigned int j = 0; j < size; ++j)
      CPPUNIT_ASSERT_EQUAL_MESSAGE(
          "testOperators8 : ", ((*res)(i, j) - (*tmp1)(i) * (*x)(j)) < tol, true);

  res->zero();
  auto w = std::make_shared<SiconosVector>(*sv);
  *res = siconos::algebra::outer_prod(*tmp1, *w);  // dense*sparse
  for (unsigned int i = 0; i < size1; ++i)
    for (unsigned int j = 0; j < size; ++j)
      CPPUNIT_ASSERT_EQUAL_MESSAGE(
          "testOperators8 : ", ((*res)(i, j) - (*tmp1)(i) * (*w->sparse())(j)) < tol, true);
  ...
  *res2 = siconos::algebra::outer_prod(*v, *w);  // sparse*sparse
  for (unsigned int i = 0; i < size1; ++i)
    for (unsigned int j = 0; j < size; ++j)
      CPPUNIT_ASSERT_EQUAL_MESSAGE(
          "testOperators8 : ", ((*res2)(i, j) - (*v->sparse())(i) * (*w->sparse())(j)) < tol,
          true);
  res->zero();

  *res2 = siconos::algebra::outer_prod(*v, *x);  // sparse*dense
  for (unsigned int i = 0; i < size1; ++i)
    for (unsigned int j = 0; j < size; ++j)
      CPPUNIT_ASSERT_EQUAL_MESSAGE(
          "testOperators8 : ", ((*res2)(i, j) - (*v->sparse())(i) * (*x)(j)) < tol, true);
...
void SiconosVectorTest::testSubscal() {
  ...
  auto ys = std::make_shared<SiconosVector>(size, 2.0);

  auto yy = std::make_shared<siconos::algebra::BlockVector>();
  auto y1 = std::make_shared<SiconosVector>(2, 1.0);
  auto y2 = std::make_shared<SiconosVector>(3, 2.0);
  auto y3 = std::make_shared<SiconosVector>(7, 4.0);
  yy->insertPtr(y1);
  yy->insertPtr(y2);
  yy->insertPtr(y3);
  auto yref = std::make_shared<SiconosVector>(*ys);
  ...
  //
  // xx sparse, ys dense
  xx = std::make_shared<SiconosVector>(size, siconos::algebra::UblasType::SPARSE);
  xx->fill(2.0);
  *yref = *ys;
  subscal(a, *xx, *ys, coord, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(4) - a * (*xx)(1)) < tol, true);
  ...
  // xx sparse, ys sparse
  ys = std::make_shared<SiconosVector>(size, siconos::algebra::UblasType::SPARSE);
  *yref = *ys;
  subscal(a, *xx, *ys, coord, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(4) - a * (*xx)(1)) < tol, true);
  CPPUNIT_ASSERT_EQUAL_MESSAGE("testSubscal : ", fabs((*ys)(5) - a * (*xx)(2)) < tol, true);
  for (unsigned int i = 0; i < size; ++i) {
    if (i != 4 && i != 5)
      CPPUNIT_ASSERT_EQUAL_MESSAGE(
          "testSubscal : ", fabs((*ys->sparse())(i) - (*yref->dense())(i)) < tol, true);
  }
