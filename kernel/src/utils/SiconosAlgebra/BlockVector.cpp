                                           ...
                                           std::shared_ptr<SiconosVector> v2)
{
  ...
  else  // If second parameter is a nullptr pointer, then set this(2) to a SiconosVector of the
        // same size as v1, and equal to 0.
  {
    // This case is usefull to set xDot in LagrangianDS.
...
siconos::algebra::BlockVector& siconos::algebra::BlockVector::operator=(const BlockVector& vIn)
{
  if (&vIn == this)
    return *this;
  else {
