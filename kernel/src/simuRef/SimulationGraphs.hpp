...
// #include "SiconosAlgebraTypes.hpp"  // for VectorOfVectors, ...
// #include "SiconosFwd.hpp"           // for std::shared_ptr<DynamicalSystem>, ...
...
struct DynamicalSystemProperties {
  ...
  unsigned int absolute_position; /**< Absolute position of the ds variables in the unknown
                                     vector in osnsp*/
...
struct DynamicalSystemsGraph : public _DynamicalSystemsGraph {
  ...
  INSTALL_GRAPH_PROPERTIES(
      DynamicalSystems, ((siconos::internal::VertexSP, siconos::simulation::MatrixIntegrator,
                          Ad))  // for ZOH Integration
      ((siconos::internal::VertexSP, siconos::simulation::MatrixIntegrator,
        AdInt))  // for ZOH Integration
      ((siconos::internal::VertexSP, siconos::simulation::MatrixIntegrator,
        Ld))  // For Observer (ZOH Integration)
      ((siconos::internal::VertexSP, siconos::simulation::MatrixIntegrator,
        Bd))  // For Controlled System (ZOH Integration)
      ((siconos::internal::VertexSP, siconos::algebra::SiconosMatrix,
        B))  // For Controlled System
      ((siconos::internal::VertexSP, siconos::algebra::SiconosMatrix, L))  // For Observer
      ((siconos::internal::VertexSP, siconos::plugins::PluggedObject,
        pluginB))  // For Controlled System
      ((siconos::internal::VertexSP, siconos::plugins::PluggedObject,
        pluginL))                                                          // For Observer
      ((siconos::internal::VertexSP, siconos::algebra::SiconosVector, e))  // For Observer
      ((siconos::internal::VertexSP, siconos::algebra::SiconosVector,
      ...
      ((siconos::internal::VertexSP, siconos::algebra::SimpleMatrix,
...
struct InteractionsGraph : public _InteractionsGraph {
  ...
  INSTALL_GRAPH_PROPERTIES(
      Interactions,
      ((siconos::internal::Vertex, std::shared_ptr<siconos::algebra::SimpleMatrix>,
        blockProj))  // ProjectOnConstraint
      ((siconos::internal::Edge, std::shared_ptr<siconos::algebra::SimpleMatrix>,
        upper_blockProj))  // idem
      ((siconos::internal::Edge, std::shared_ptr<siconos::algebra::SimpleMatrix>,
        lower_blockProj))  // idem
      ((siconos::internal::Vertex, std::string, name)));
