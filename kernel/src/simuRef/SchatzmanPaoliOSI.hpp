...
public:
   ...
   */
  void setW(const SiconosMatrix &newValue, std::shared_ptr<siconos::modeling::DynamicalSystem> ds);
   ...
   */
  void computeW(double time, std::shared_ptr<siconos::modeling::DynamicalSystem> ds, SiconosMatrix &W);
