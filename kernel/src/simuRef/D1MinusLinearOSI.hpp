...
public:
   ...
   */
  bool addInteractionInIndexSet(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i) override;
   ...
   */
  virtual bool
  addInteractionInIndexSetHalfExplicitAccelerationLevel(std::shared_ptr<siconos::modeling::Interaction> inter,
                                                        unsigned int i);
   ...
   */
  virtual bool
  addInteractionInIndexSetHalfExplicitVelocityLevel(std::shared_ptr<siconos::modeling::Interaction> inter,
                                                    unsigned int i);
   ...
   */
  virtual bool
  removeInteractionFromIndexSetHalfExplicitVelocityLevel(std::shared_ptr<siconos::modeling::Interaction> inter,
                                                         unsigned int i);
