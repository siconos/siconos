...
SP::VectorOfVectors
OneStepIntegrator::_initializeDSWorkVectors(std::shared_ptr<siconos::modeling::DynamicalSystem> ds)
{
  ...
  auto wv = std::make_shared<VectorOfVectors>();
...
double OneStepIntegrator::computeResiduOutput(double time, std::shared_ptr<InteractionsGraph> indexSet)
{
  double residu =0.0;
...
double OneStepIntegrator::computeResiduInput(double time, std::shared_ptr<InteractionsGraph> indexSet)
{
  double residu =0.0;
