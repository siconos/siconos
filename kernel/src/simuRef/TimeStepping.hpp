...
public:
  ...
  //  */
  // virtual bool predictorDeactivate(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i);

  // /** Used by the updateIndexSet function in order to activate
  // std::shared_ptr<siconos::modeling::Interaction>.
  //  */
  // virtual bool predictorActivate(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i);
