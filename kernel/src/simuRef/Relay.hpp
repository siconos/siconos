...
protected:
  ...
  std::shared_ptr<siconos::algebra::SiconosVector> _lb;

  /** contains the vector ub (upper bounds) of a Relay system */
  std::shared_ptr<siconos::algebra::SiconosVector> _ub;
...
public:
   ...
   *  \return the vector of lower bounds
   */
  inline std::shared_ptr<siconos::algebra::SiconosVector> lb() const
  {
    return _lb;
  }
   ...
   */
  inline void setLb(std::shared_ptr<siconos::algebra::SiconosVector> newLb)
  {
    _lb = newLb;
  }
   ...
   *  \return the vector of upper bounds
   */
  inline std::shared_ptr<siconos::algebra::SiconosVector> ub() const
  {
    return _ub;
  }
   ...
   */
  inline void setUb(std::shared_ptr<siconos::algebra::SiconosVector> newUb)
  {
    _ub = newUb;
  }
