...
public:
   ...
   */
  virtual void displayBlocks(std::shared_ptr<InteractionsGraph> indexSet);
  ...
  */
  std::shared_ptr<siconos::algebra::SimpleMatrix> getOSIMatrix(OneStepIntegrator& osi, std::shared_ptr<siconos::modeling::DynamicalSystem> ds);
