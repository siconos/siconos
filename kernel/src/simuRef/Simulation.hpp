...
protected:
  ...
  */
   ...
   */
  std::shared_ptr<siconos::modeling::Interaction>Manager _interman;
  ...
  */
  ...
  std::map< SP::OneStepIntegrator, std::list<std::shared_ptr<siconos::modeling::DynamicalSystem>> >  _OSIDSmap;
...
public:
  ...
  */
  ...
  void associate(SP::OneStepIntegrator osi, std::shared_ptr<siconos::modeling::DynamicalSystem> ds);
   ...
   */
  std::shared_ptr<InteractionsGraph> indexSet(unsigned int i);
  ...
  */
   ...
   *  topology updates. */
  virtual void initializeInteraction(double time, std::shared_ptr<siconos::modeling::Interaction> inter);

  /** Set an object to automatically manage interactions during the simulation
   *
   *  \param manager
   */
  void insertInteractionManager(std::shared_ptr<siconos::modeling::Interaction>Manager manager)
    { _interman = manager; }
  ...
  */
  ...
  /**
     ...
     \return a std::shared_ptr<siconos::algebra::SiconosVector> that contains the concatenated value
  */
  std::shared_ptr<siconos::algebra::SiconosVector> lambda(unsigned int level = 0, unsigned int coor=0 );
  ...
  /** 
      ...
      \return a std::shared_ptr<siconos::algebra::SiconosVector> that contains the concatenated value
  */
  std::shared_ptr<siconos::algebra::SiconosVector> y(unsigned int level = 0, unsigned int coor=0 );
   ...
   *  \param ds1 the first std::shared_ptr<siconos::modeling::DynamicalSystem> in the Interaction
   *  \param ds2 the second std::shared_ptr<siconos::modeling::DynamicalSystem> in the Interaction, if any
   */
  void link(std::shared_ptr<siconos::modeling::Interaction> inter,
            std::shared_ptr<siconos::modeling::DynamicalSystem> ds1,
            std::shared_ptr<siconos::modeling::DynamicalSystem> ds2 = std::shared_ptr<siconos::modeling::DynamicalSystem>());
