...
private:
  ...
  std::shared_ptr<siconos::algebra::BlockVector> _qWork;
  /** temporary vector to save v values */
  std::shared_ptr<siconos::algebra::BlockVector> _vWork;
  /** temporary vector to save v values */
  std::shared_ptr<siconos::algebra::BlockVector> _uWork;
  /** temporary vector to save a values */
  std::shared_ptr<siconos::algebra::BlockVector> _aWork;
  /** temporary vector to save lambda values */
  std::shared_ptr<siconos::algebra::BlockVector> _lambdaWork;
  /** temporary vector to save forces values */
  std::shared_ptr<siconos::algebra::BlockVector> _forcesWork;

  std::shared_ptr<siconos::algebra::SiconosVector> _qtmp;
  std::shared_ptr<siconos::algebra::SiconosVector> _vtmp;
  std::shared_ptr<siconos::algebra::SiconosVector> _utmp;
  std::shared_ptr<siconos::algebra::SiconosVector> _atmp;
  std::shared_ptr<siconos::algebra::SiconosVector> _lambdatmp;
  std::shared_ptr<siconos::algebra::SiconosVector> _forcestmp;
