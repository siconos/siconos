...
void MoreauJeanDirectProjectionOSI::initializeWorkVectorsForDS(double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds)
{
  DEBUG_BEGIN("MoreauJeanDirectProjectionOSI::initializeWorkVectorsForDS( double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds) \n");
  ...
  DEBUG_END("MoreauJeanDirectProjectionOSI::initializeWorkVectorsForDS( double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds) \n");

}

void MoreauJeanDirectProjectionOSI::initializeWorkVectorsForInteraction(siconos::modeling::Interaction&inter, InteractionProperties& interProp,
    siconos::graphs::DynamicalSystemsGraph & DSG)
{
  DEBUG_BEGIN("MoreauJeanDirectProjectionOSI::initializeWorkVectorsForInteraction(siconos::modeling::Interaction&inter, InteractionProperties& interProp, siconos::graphs::DynamicalSystemsGraph & DSG)\n");
  ...
  DEBUG_END("MoreauJeanDirectProjectionOSI::initializeWorkVectorsForInteraction(siconos::modeling::Interaction&inter, InteractionProperties& interProp, siconos::graphs::DynamicalSystemsGraph & DSG)\n");
...
bool MoreauJeanDirectProjectionOSI::addInteractionInIndexSet(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i)
{
  return MoreauJeanOSI::addInteractionInIndexSet(inter, i);
}

bool MoreauJeanDirectProjectionOSI::removeInteractionFromIndexSet(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i)
{
