...
void LsodarOSI::initializeWorkVectorsForDS(double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds)
{
  DEBUG_BEGIN("LsodarOSI::initializeWorkVectorsForDS( double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds)\n");
  ...
  DEBUG_END("LsodarOSI::initializeWorkVectorsForDS( double t, std::shared_ptr<siconos::modeling::DynamicalSystem> ds)\n");
}
...
void LsodarOSI::initialize()
{
  ...
  // std::shared_ptr<InteractionsGraph> indexSet0 = m.nonSmoothDynamicalSystem()->topology()->indexSet0();
