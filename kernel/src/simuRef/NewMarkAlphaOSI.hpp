...
public:
   ...
   * \return  SimpleMatrix
   */
  const SimpleMatrix getW(std::shared_ptr<siconos::modeling::DynamicalSystem> ds);
   ...
   */
  void computeW(std::shared_ptr<siconos::modeling::DynamicalSystem> ds, SiconosMatrix &W);
