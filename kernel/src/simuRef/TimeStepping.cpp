...
// bool TimeStepping::predictorDeactivate(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i)
// {
//   double h = timeStep();
...
// bool TimeStepping::predictorActivate(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int i)
// {
//   double h = timeStep();
//   double y = inter->getYRef(i-1); // for i=1 it is the position -> historic notation y
//   double yDot = inter->getYRef(i); // for i=1 it is the velocity -> historic notation yDot
