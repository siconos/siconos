...
public:
  ...
  */
  void computeOptions(std::shared_ptr<siconos::modeling::Interaction> inter1, std::shared_ptr<siconos::modeling::Interaction> inter2) override;
  ...
  */
  virtual void postComputeLagrangianR(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int pos);

  /** post-treatment for  MLCPProjectOnConstraints for NewtonEulerR
      \param inter the considered interaction
      \param pos interaction position in the global vector
   */
  virtual void postComputeNewtonEulerR(std::shared_ptr<siconos::modeling::Interaction> inter, unsigned int pos);
