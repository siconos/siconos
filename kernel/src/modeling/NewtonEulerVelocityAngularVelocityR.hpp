...
class NewtonEulerVelocityAngularVelocityR : public NewtonEuler1DR {
 private:
  ACCEPT_SERIALIZATION(NewtonEulerVelocityAngularVelocityR);
 ...
 public:
  /** destructor
   */
  virtual ~NewtonEulerVelocityAngularVelocityR() noexcept = default;
