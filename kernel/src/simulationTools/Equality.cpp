...
siconos::nonsmooth_formulations::Equality::Equality(int numericsSolverId) {}

siconos::nonsmooth_formulations::Equality::Equality(std::shared_ptr<SolverOptions> options)
    : LinearOSNS(options) {}
