...
void siconos::integrators::Hem5OSI::initializeWorkVectorsForDS(
  ...
  if (!_qWork) _qWork = std::make_shared<siconos::algebra::BlockVector>();
  if (!_vWork) _vWork = std::make_shared<siconos::algebra::BlockVector>();
  if (!_aWork) _aWork = std::make_shared<siconos::algebra::BlockVector>();
  if (!_uWork) _uWork = std::make_shared<siconos::algebra::BlockVector>();
  if (!_lambdaWork) _lambdaWork = std::make_shared<siconos::algebra::BlockVector>();
...
void siconos::integrators::Hem5OSI::initializeWorkVectorsForInteraction(
  ...
  if (!interProp.workBlockVectors) {
    interProp.workBlockVectors =
        std::make_shared<std::vector<std::shared_ptr<siconos::algebra::BlockVector>>>(
            siconos::integrators::Hem5OSI::BLOCK_WORK_LENGTH);
  }
  ...
  inter_work[siconos::integrators::Hem5OSI::OSNSP_RHS] =
...
void siconos::integrators::Hem5OSI::integrate(double& tinit, double& tend, double& tout,
  ...
  DEBUG_PRINTF("siconos::integrators::Hem5OSI::integrate() _intData[2] (NU) = %i \n",
               _intData[2]);
  ...
  DEBUG_PRINTF("siconos::integrators::Hem5OSI::integrate() _intData[6] (LWK) = %i \n",
               _intData[6]);
  DEBUG_PRINTF("siconos::integrators::Hem5OSI::integrate() _intData[7] (LIWK) = %i \n",
               _intData[7]);

  siconos::integrators::Hem5OSI::updateData();
...
void siconos::integrators::Hem5OSI::computeFreeOutput(
  ...
  auto& osnsp_rhs = *(*indexSet->properties(vertex_inter)
                           .workVectors)[siconos::integrators::Hem5OSI::OSNSP_RHS];
