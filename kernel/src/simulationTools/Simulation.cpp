...
// --- Constructor with a TimeDiscretisation (and thus a Model)
Simulation::Simulation(SP::TimeDiscretisation td):
  _name("unnamed"), _tinit(0.0), _tend(0.0), _tout(0.0),
  _numberOfIndexSets(0), _tolerance(DEFAULT_TOLERANCE), _printStat(false),
  _useRelativeConvergenceCriterion(false), _relativeConvergenceCriterionHeld(false),
