  ...
  FirstOrderR(RELATION::Type2R)
{
  ...
  setComputehFunction(siconos::plugins::getPluginName(pluginh), siconos::plugins::getPluginFunctionName(pluginh));
  setComputegFunction(siconos::plugins::getPluginName(pluging), siconos::plugins::getPluginFunctionName(pluging));
  ...
  FirstOrderR(RELATION::Type2R)
{
  ...
  setComputeJachxFunction(siconos::plugins::getPluginName(pluginJacobianhx), siconos::plugins::getPluginFunctionName(pluginJacobianhx));
  setComputeJacglambdaFunction(siconos::plugins::getPluginName(pluginJacobianglambda), siconos::plugins::getPluginFunctionName(pluginJacobianglambda));
}
...
//  if (!_jacgx)
//  {
//    relationMat[FirstOrderR::mat_K] = std::make_shared<siconos::algebra::SimpleMatrix>(sizeDS, sizeDS));
