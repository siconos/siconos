...
protected:
   ...
   */
  std::shared_ptr<siconos::algebra::SimpleMatrix> _dotjachq;

  std::shared_ptr<siconos::algebra::SimpleMatrix> _jachlambda;
  std::shared_ptr<siconos::algebra::SimpleMatrix> _jacglambda;
  ...
  std::shared_ptr<siconos::algebra::SiconosVector> _contactForce;
  ...
  std::shared_ptr<siconos::algebra::SimpleMatrix> _jachqT;

  /** local storage of _T as working vector to compute JachqT from q */
  std::shared_ptr<siconos::algebra::SimpleMatrix> _T;
  ...
  NewtonEulerR(RELATION::SUBTYPES lagType)
      : Relation(RELATION::NewtonEuler, lagType)
  {
  }
...
public:
  ...
  // proj_with_q  inline std::shared_ptr<siconos::algebra::SimpleMatrix> jachqProj() const { return _jachqProj;
  // }
  ...
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> jachlambda() const { return _jachlambda; }
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> jacglambda() const { return _jacglambda; }
  ...
  inline void setJachqT(std::shared_ptr<siconos::algebra::SimpleMatrix> newJachqT) { _jachqT = newJachqT; }
  ...
  */
  ...
  virtual void computeDotJachq(double time, const BlockVector &workQ,
                               BlockVector &workZ, const BlockVector &workQdot);
   ...
   */
  virtual inline std::shared_ptr<siconos::algebra::SimpleMatrix> D() const { return _jachlambda; }
  /** return a SP on the B matrix.
   *  The matrix B in the linear case, else it returns Jacobian of the input with
   *  respect to lambda.
   */
  virtual inline std::shared_ptr<siconos::algebra::SimpleMatrix> B() const { return _jacglambda; }
  ...
  */
  inline std::shared_ptr<siconos::algebra::SiconosVector> contactForce() const { return _contactForce; };
