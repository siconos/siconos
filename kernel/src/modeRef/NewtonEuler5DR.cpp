...
void NewtonEuler5DR::initialize(Interaction& inter)
{
  ...
  _jachq = std::make_shared<siconos::algebra::SimpleMatrix>(5, qSize));
...
void NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)
{
  DEBUG_BEGIN("NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)\n");
  ...
  if(orthoBaseFromVector(&Nx, &Ny, &Nz, pt, pt + 1, pt + 2, pt + 3, pt + 4, pt + 5))
    THROW_EXCEPTION("NewtonEuler5DR::RFC3DcomputeJachqTFromContacts. Problem in calling orthoBaseFromVector");
  ...
  // DEBUG_EXPR_WE(
  //   std::shared_ptr<siconos::algebra::SimpleMatrix> jaux = std::make_shared<siconos::algebra::SimpleMatrix>(*_jachqT));
  //   jaux->trans();
  //   std::shared_ptr<siconos::algebra::SiconosVector> v = std::make_shared<siconos::algebra::SiconosVector>(3));
  //   std::shared_ptr<siconos::algebra::SiconosVector> vRes = std::make_shared<siconos::algebra::SiconosVector>(6));
  //   v->zero();
  //   v->setValue(0, 1);
  ...
  //   vRes->display();
  //   );
  DEBUG_END("NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)\n");

}

void NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1, std::shared_ptr<siconos::algebra::SiconosVector> q2)
{

  DEBUG_BEGIN("NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1, std::shared_ptr<siconos::algebra::SiconosVector> q2)\n");
  ...
  DEBUG_END("NewtonEuler5DR::RFC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1, std::shared_ptr<siconos::algebra::SiconosVector> q2)\n");
