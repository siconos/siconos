...
LagrangianLinearTIR::LagrangianLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C):
...
LagrangianLinearTIR::LagrangianLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C,  std::shared_ptr<siconos::algebra::SimpleMatrix> F, std::shared_ptr<siconos::algebra::SiconosVector> e):
  LagrangianR(LinearTIR)
{
  _jachq = C;
  _F = F;
...
LagrangianLinearTIR::LagrangianLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SiconosVector> e):
  LagrangianR(LinearTIR)
{
  _jachq = C;
  _e = e;
