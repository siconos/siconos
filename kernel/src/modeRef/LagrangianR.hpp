...
public:
   ...
   */
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> jachq() const
  {
    return _jachq;
  }
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> jachqDot() const
  {
    return _jachqDot;
  }
  ...
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> H() const override
  {
    return _jachq;
  }
