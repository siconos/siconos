...
public:
   ...
   */
  FirstOrderLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> B);
   ...
   */
  FirstOrderLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> D,
                      std::shared_ptr<siconos::algebra::SimpleMatrix> F, std::shared_ptr<siconos::algebra::SiconosVector> e,
