...
protected:
   ...
   * row.
   */
  std::shared_ptr<siconos::algebra::SimpleMatrix> _RotationAbsToContactFrame;

  /* Matrix converting */
  std::shared_ptr<siconos::algebra::SimpleMatrix> _rotationMatrixAbsToBody;
...
public:
   ...
   */
  Lagrangian2d3DR()
      : LagrangianScleronomousR(), _Pc1 = std::make_shared<siconos::algebra::SiconosVector>(2)),
        _Pc2 = std::make_shared<siconos::algebra::SiconosVector>(2)), _Nc = std::make_shared<siconos::algebra::SiconosVector>(2))
  {
