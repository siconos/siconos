...
void LagrangianCompliantLinearTIRTest::testSetCPtr()
{
  ...
  std::shared_ptr<siconos::algebra::SimpleMatrix> tmpC = std::make_shared<siconos::algebra::SimpleMatrix>(*C));
  tmpC->zero();
  std::shared_ptr<siconos::algebra::SimpleMatrix> tmpD = std::make_shared<siconos::algebra::SimpleMatrix>(*D));
  tmpD->zero();
...
void LagrangianCompliantLinearTIRTest::testSetDPtr()
{
  ...
  std::shared_ptr<siconos::algebra::SimpleMatrix> tmp = std::make_shared<siconos::algebra::SimpleMatrix>(*D));
  tmp->zero();
