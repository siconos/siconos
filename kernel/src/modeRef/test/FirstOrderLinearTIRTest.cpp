...
void FirstOrderLinearTIRTest::testSetCPtr()
{
  ...
  std::shared_ptr<siconos::algebra::SimpleMatrix> tmp = std::make_shared<siconos::algebra::SimpleMatrix>(*C));
  tmp->zero();
...
void FirstOrderLinearTIRTest::testSetBPtr()
{
  ...
  std::shared_ptr<siconos::algebra::SimpleMatrix> tmp = std::make_shared<siconos::algebra::SimpleMatrix>(*B));
  tmp->zero();
