...
LagrangianCompliantR::LagrangianCompliantR(const std::string& pluginh, const std::string& pluginJacobianhq, const std::string& pluginJacobianhlambda) : LagrangianR(CompliantR)
{
  ...
  _pluginJachq->setComputeFunction(siconos::plugins::getPluginName(pluginJacobianhq), siconos::plugins::getPluginFunctionName(pluginJacobianhq));
  _pluginJachlambda->setComputeFunction(siconos::plugins::getPluginName(pluginJacobianhlambda), siconos::plugins::getPluginFunctionName(pluginJacobianhlambda));
}
