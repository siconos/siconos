  ...
  FirstOrderR(RELATION::Type1R)
{
  ...
  setComputehFunction(siconos::plugins::getPluginName(pluginh), siconos::plugins::getPluginFunctionName(pluginh));
  setComputegFunction(siconos::plugins::getPluginName(pluging), siconos::plugins::getPluginFunctionName(pluging));
  setComputeJachxFunction(siconos::plugins::getPluginName(pluginJachx), siconos::plugins::getPluginFunctionName(pluginJachx));
  setComputeJacglambdaFunction(siconos::plugins::getPluginName(pluginJacglambda), siconos::plugins::getPluginFunctionName(pluginJacglambda));
}
