...
void NewtonEuler3DR::FC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)
{
  DEBUG_BEGIN("NewtonEuler3DR::FC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)\n");
  ...
  //   vRes->display();
  //   );
  DEBUG_END("NewtonEuler3DR::FC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1)\n");
}

void NewtonEuler3DR::FC3DcomputeJachqTFromContacts(std::shared_ptr<siconos::algebra::SiconosVector> q1, std::shared_ptr<siconos::algebra::SiconosVector> q2)
{
  double Nx = _Nc->getValue(0);
  double Ny = _Nc->getValue(1);
  double Nz = _Nc->getValue(2);
