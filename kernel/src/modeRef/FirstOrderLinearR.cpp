...
FirstOrderLinearR::FirstOrderLinearR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> B)
    : FirstOrderR(LinearR) {
  _C = C;
  _B = B;
}
...
FirstOrderLinearR::FirstOrderLinearR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> D,
