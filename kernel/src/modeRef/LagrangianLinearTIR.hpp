...
public:
   ...
   */
  LagrangianLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> F,
   ...
   *  \param e the vector e
   */
  LagrangianLinearTIR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SiconosVector> e);
   ...
   */
  inline std::shared_ptr<siconos::algebra::SimpleMatrix> C() const override
  {
    return _jachq;
  }
   ...
   */
  inline void setCPtr(std::shared_ptr<siconos::algebra::SimpleMatrix> newPtr) { _jachq = newPtr; }
   ...
   *  \param newPtr a SP to plugged matrix
   */
  inline void setDPtr(std::shared_ptr<siconos::algebra::SimpleMatrix> newPtr) { _jachlambda = newPtr; }
