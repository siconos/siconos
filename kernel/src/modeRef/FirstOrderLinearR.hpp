...
public:
   ...
   */
  FirstOrderLinearR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> B);
   ...
   *  \param B the B matrix
   */
  FirstOrderLinearR(std::shared_ptr<siconos::algebra::SimpleMatrix> C, std::shared_ptr<siconos::algebra::SimpleMatrix> D, std::shared_ptr<siconos::algebra::SimpleMatrix> F,
                    std::shared_ptr<siconos::algebra::SiconosVector> e, std::shared_ptr<siconos::algebra::SimpleMatrix> B);
  ...
  */
   ...
   */
  inline void setePtr(std::shared_ptr<siconos::algebra::SiconosVector> newe) { _e = newe; }
