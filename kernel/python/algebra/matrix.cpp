...
void init_siconos_matrix(py::module &m)
{
  py::class_<siconos::algebra::SiconosMatrix,
             std::shared_ptr<siconos::algebra::SiconosMatrix>>(m, "SiconosMatrix");

  py::class_<siconos::algebra::SimpleMatrix, siconos::algebra::SiconosMatrix,
             std::shared_ptr<siconos::algebra::SimpleMatrix>>(m, "SimpleMatrix",
                                                              py::buffer_protocol())
      .def_buffer([](siconos::algebra::SimpleMatrix &mat) -> py::buffer_info {
        return py::buffer_info(mat.getArray(), /* Pointer to buffer */
      ...
      //.def(py::init<>())
      .def(py::init<unsigned int, unsigned int, siconos::algebra::UblasType>(), py::arg("row"),
           py::arg("col"), py::arg("storage_type") = siconos::algebra::UblasType::DENSE)
      .def("size", &siconos::algebra::SimpleMatrix::size)
      // .def("print", py::overload_cast<>(&siconos::algebra::SimpleMatrix::display,
      // py::const_))
