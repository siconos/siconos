...
PYBIND11_MODULE(nonsmooth_formulations, m) {
  ...
  py::class_<siconos::nonsmooth_formulations::OneStepNSProblem, py::smart_holder>(
      m, "OneStepNSProblem")
  ...
  py::class_<siconos::nonsmooth_formulations::LinearOSNS,
             siconos::nonsmooth_formulations::OneStepNSProblem, py::smart_holder>(m,
                                                                                  "LinearOSNS")
  ...
  py::class_<siconos::nonsmooth_formulations::LCP, siconos::nonsmooth_formulations::LinearOSNS,
             py::smart_holder>(m, "LCP")
  ...
  py::class_<siconos::nonsmooth_formulations::Relay,
             siconos::nonsmooth_formulations::LinearOSNS, py::smart_holder>(m, "Relay")
      .def(py::init<int>(),
  ...
  py::class_<siconos::nonsmooth_formulations::FrictionContact,
             siconos::nonsmooth_formulations::LinearOSNS, py::smart_holder>(m,
                                                                            "FrictionContact")
  ...
  py::class_<siconos::nonsmooth_formulations::RollingFrictionContact,
             siconos::nonsmooth_formulations::LinearOSNS, py::smart_holder>(
      m, "RollingFrictionContact")
      .def(py::init<int, int>(), py::arg("dimPb") = 3,
  ...
  py::class_<siconos::nonsmooth_formulations::MLCP,
             siconos::nonsmooth_formulations::LinearOSNS, py::smart_holder>(m, "MLCP")
  ...
  py::class_<siconos::nonsmooth_formulations::MLCPProjectOnConstraints,
             siconos::nonsmooth_formulations::MLCP, py::smart_holder>(
      m, "MLCPProjectOnConstraints")
  ...
  py::class_<siconos::nonsmooth_formulations::GlobalRollingFrictionContact,
             siconos::nonsmooth_formulations::GlobalFrictionContact, py::smart_holder>(
