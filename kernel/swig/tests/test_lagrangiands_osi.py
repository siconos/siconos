...
ds_list['LTIDS+MJ'] = sk.LagrangianLinearTIDS(q0, v0, np.diag(mass_diag),
                                              np.diag(k_diag), np.diag(c_diag))
ds_list['LLDDS+MJ'] = sk.LagrangianLinearDiagonalDS(q0, v0, mass_diag,
                                                    k_diag, c_diag)
ds_list['LLDDS+MJB'] = sk.LagrangianLinearDiagonalDS(q0, v0, mass_diag,
                                                     k_diag, c_diag)
