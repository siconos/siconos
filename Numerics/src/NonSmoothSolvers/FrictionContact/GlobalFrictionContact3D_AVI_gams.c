...
{
  *info = globalFrictionContact3D_AVI_gams_base(problem, reaction, velocity, options, "path");
}
...
{
  *info = globalFrictionContact3D_AVI_gams_base(problem, reaction, velocity, options, "pathvi");
}
