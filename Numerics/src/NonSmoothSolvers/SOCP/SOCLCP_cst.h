...
enum SOCLCP_SOLVER
{
  ...
  /* SICONOS_SOCLCP_LOCALAC = 504, */
  /* SICONOS_SOCLCP_DSFP = 505, */
  /* SICONOS_SOCLCP_VI_FPP = 506, */
  /* SICONOS_SOCLCP_VI_EG = 507, */
  /* SICONOS_SOCLCP_HP = 508, */
  /* SICONOS_SOCLCP_NCPGlockerFBFixedPoint = 510, */
  /* SICONOS_SOCLCP_FPP = 511, */
  /* SICONOS_SOCLCP_EG = 512, */
...
extern char *  SICONOS_SOCLCP_LOCALAC_STR ;
extern char *  SICONOS_SOCLCP_LOCALFB_STR ;
...
extern char *  SICONOS_SOCLCP_GLOBAL_LOCALAC_WR_STR ;
