  ...
  */
  ...
  while ((niter < itermax) && (terminationCriterion > tolerance))
  {
      ...
      if (10 * (itermax)*fabs(prev_psi_z - psi_z) < psi_z)
      {
        ...
        for (j = 0; j < 10; j++)
        {
          ...
          for (i = 0; i < n; i++)
          {
            ...
            /* zaux = z + dir */
            DAXPY(n , norm , sdir , incx , szaux , incx);
    ...
    */
    ...
    /*linesearch_Armijo(n,z,phi_z,psi_z, descentCondition, phi);*/
