...
char * idToName(int Id)
{
  ...
  case SICONOS_FRICTION_3D_EG:
    return SICONOS_FRICTION_3D_EG_STR;
  case SICONOS_FRICTION_3D_HP:
    return SICONOS_FRICTION_3D_HP_STR;
  ...
  case SICONOS_FRICTION_3D_GLOBAL_NSGS_WR:
    return SICONOS_FRICTION_3D_GLOBAL_NSGS_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_NSGSV_WR:
    return SICONOS_FRICTION_3D_GLOBAL_NSGSV_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_PROX_WR:
    return SICONOS_FRICTION_3D_GLOBAL_PROX_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_DSFP_WR:
    return SICONOS_FRICTION_3D_GLOBAL_DSFP_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_TFP_WR:
    return SICONOS_FRICTION_3D_GLOBAL_TFP_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_GLOBALAC_WR:
    return SICONOS_FRICTION_3D_GLOBAL_GLOBALAC_WR_STR;
  case SICONOS_FRICTION_3D_GLOBAL_NSGS:
    return SICONOS_FRICTION_3D_GLOBAL_NSGS_STR;
    // MCP
  case SICONOS_MCP_FB:
...
int nameToId(char * pName)
{
  ...
  /*FRICTION_3D_GLOBAL**/
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_NSGS_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_NSGS_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_NSGSV_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_NSGSV_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_PROX_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_PROX_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_DSFP_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_DSFP_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_TFP_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_TFP_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_GLOBALAC_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_GLOBALAC_WR;
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_NSGS_STR, pName) == 0)
