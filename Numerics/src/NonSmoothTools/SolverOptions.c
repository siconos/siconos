...
char * idToName(int Id)
{
 ...
 case    SICONOS_MLCP_PGS_SBM:
  ...
  case SICONOS_FRICTION_3D_GLOBAL_LOCALAC_WR:
    return SICONOS_FRICTION_3D_GLOBAL_LOCALAC_WR_STR;
...
int nameToId(char * pName)
{
  ...
  else if (strcmp(SICONOS_FRICTION_3D_GLOBAL_LOCALAC_WR_STR, pName) == 0)
    return SICONOS_FRICTION_3D_GLOBAL_LOCALAC_WR;
