 ...
 *   \f$
 *
 * here M is a SparseBlockStructuredMatrix.
 *
 * \fn  pfc_3D_nsgs_block( int nc, SparseBlockStructuredMatrix *M , double *q , double *z , double *w , double *mu,
 *                         int *info\n, int *iparam , double *dparamLCP )
 *
