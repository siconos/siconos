...
/*!\fn  qp_lcp(double vec[],double *qq,int *nn,int * itermax, double * tol,double z[],double w[],int *it_end,double * res,int *info)

qp_lcp use a quadratic programm formulation fpor solving an LCP
...
void qp_lcp(double vec[], double *qq, int *nn, double * tol, double z[], double w[], int *info)
{
  int i, j;
