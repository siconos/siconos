...
/*!\fn  int lcp_dfc_2D (int *dim_nn, double *ztel, double *wtel, methode *pt, double *K1, double *F1, int * dim_F1, double *J1, int *ddl_i, int * dim_i, int *ddl_c, int *dim_c,  int *ddl_n, int *ddl_tt, int *dim_tt, double *U2,double *F2)

   lcp_dfc_2D subroutine allows to give the solution of the contact problem with friction given.
...
int lcp_dfc_2D(int *dim_nn, double *ztel, double *wtel, method *pt, double *K1, double *F1, int * dim_F1, double *J1, int *ddl_i, int * dim_i, int *ddl_c, int *dim_c,  int *ddl_n, int *ddl_tt, int *dim_tt, double *U2, double *F2)
{
