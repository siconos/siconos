...

{
  ...
  int i, j, nl, nc, nll, it, info, n = 152, dimM = n;
  double *q, *z, *w, *vec;
  double(*M)[n];
  double qi, Mij;
  char val[14], vall[14];
  //  static methode_cfp meth_cfp  = {"latin",501, 0.001,0.5,0.7};
  static methode_cfp meth_cfp  = {"Gsnl", 101, 0.000001, 0.5, 0.7};
  ...
  // second test ////////////////////////
  ///////////////////////////////////////
  static methode_cfp meth_cfp2  = {"Latin", 101, 0.001, 0.5, 0.7};
