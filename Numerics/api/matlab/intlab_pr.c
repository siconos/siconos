...
#include "../../src/NSSpack/pr_solver.c"
#include "../../src/NSSpack/pr_nlgs.c"
#include "../../src/NSSpack/pr_latin.c"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  meth_pr.pr.a = (double*)malloc(n * sizeof(double));
  meth_pr.pr.b = (double*)malloc(n * sizeof(double));
  ...
  else
  {
    ...
    printf("we enter in pr_solver using the %s method \n\n", buf);


    if (strcmp(buf, mot1) == 0)
    {
      toto = pr_solver(vec, q, &mrows1, &meth_pr, z, w);
    }
