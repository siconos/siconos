...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  double *res;
  char *Str, *mot1, *mot2, *mot3, *mot4, trans = 'T';
  methode meth_rd;
  ...
  meth_rd.rd.nom_method = Str;
  meth_rd.rd.itermax = *itermax;
  meth_rd.rd.k_latin = *k_lat;
  meth_rd.rd.tol = *tol;
  meth_rd.rd.a = (double*)malloc(mrows * sizeof(double));
  meth_rd.rd.b = (double*)malloc(mrows * sizeof(double));
  ...
  if (strcmp(Str, mot3) == 0)
    toto = solve_rd(vec, q, &mrows, &meth_rd, z, w);
