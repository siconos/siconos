...
IF (CMAKE_TOOLCHAIN_FILE)
  SET(CMAKE_SICONOS_COMPILE_OBJECT "${SiconosKernel_EXE_DIR}/siconos --noexec <SOURCE> --build-dir build -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}")
ELSE(CMAKE_TOOLCHAIN_FILE)
  SET(CMAKE_SICONOS_COMPILE_OBJECT "${SiconosKernel_EXE_DIR}/siconos --noexec <SOURCE> --build-dir build")
...
MACRO(ADD_EXAMPLE _N _EX)
  ...
  ELSEIF(CROSSCOMPILING_LINUX_TO_WINDOWS OR WINDOWS)
    SET_TESTS_PROPERTIES(${_N} PROPERTIES ENVIRONMENT "Path=@SiconosKernel_LIBRARY_DIRS@\;.")
  ELSE() # unix
