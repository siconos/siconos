...
FOREACH(_EXE ${_EXE_LIST_${_CURRENT_TEST_DIRECTORY}})
  ...
  IF(CROSSCOMPILING_LINUX_TO_WINDOWS)
    ...
    SET(PATH_VAL "@PATH_FOR_CC@\\\\\\\\\;@CMAKE_BINARY_DIR@/src\\\\\\\\\;@SICONOS_LIB_PATH@")
  ...
  IF(CPPUNIT_FOUND)
    ...
    IF(APPLE)
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT DYLD_LIBRARY_PATH=@DYLD_LIBRARY_PATH@:@SICONOS_LIB_PATH@)\n")
    ELSEIF(CROSSCOMPILING_LINUX_TO_WINDOWS OR WINDOWS)
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT \"Path=@CMAKE_BINARY_DIR@/src\;@SICONOS_LIB_PATH@\")\n")
    ELSE() # unix
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT \"LD_LIBRARY_PATH=@LD_LIBRARY_PATH@:@SICONOS_LIB_PATH@\")\n")
    ENDIF()
  ...
  ELSE(CPPUNIT_FOUND)
    ...
    set_tests_properties(${_EXE} PROPERTIES ENVIRONMENT "LD_LIBRARY_PATH=@LD_LIBRARY_PATH@:@SICONOS_LIB_PATH@")
    if(CROSSCOMPILING_LINUX_TO_WINDOWS)
      set_tests_properties(${_EXE} PROPERTIES ENVIRONMENT "Path=@CMAKE_BINARY_DIR@/src;@SICONOS_LIB_PATH@")
    endif()
    if(APPLE)
      set_tests_properties(${_EXE} PROPERTIES ENVIRONMENT DYLD_LIBRARY_PATH=@DYLD_LIBRARY_PATH@:@SICONOS_LIB_PATH@)
    endif()
