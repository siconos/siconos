...
FOREACH(_EXE ${_EXE_LIST_${_CURRENT_TEST_DIRECTORY}})
  ...
  MESSAGE(STATUS "Adding test ${_CURRENT_TEST_DIRECTORY}/${_EXE} from sources ${${_EXE}_FSOURCES}")
  ...
  IF(CPPUNIT_FOUND)
    SET_TESTS_PROPERTIES(${_EXE} PROPERTIES FAIL_REGULAR_EXPRESSION "FAILURE;FATAL ERROR")
  ENDIF(CPPUNIT_FOUND)

  ADD_CUSTOM_COMMAND(TARGET ${_EXE}
    POST_BUILD
    COMMAND ${CMAKE_CURRENT_BINARY_DIR}/${_EXE}
    ARGS -d > ${CMAKE_CURRENT_BINARY_DIR}/${_EXE}.cmake
