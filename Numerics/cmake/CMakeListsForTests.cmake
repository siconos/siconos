...
FOREACH(_EXE ${_EXE_LIST_${_CURRENT_TEST_DIRECTORY}})
  ...
  IF(CPPUNIT_FOUND)
    ...
    ELSEIF(CROSSCOMPILING_LINUX_TO_WINDOWS OR WINDOWS)
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT \"Path=${CMAKE_BINARY_DIR}/src\;${CMAKE_BINARY_DIR}/src/plugin/test\;${SiconosNumerics_PATH}\")\n")
    ELSE() # unix
