...
FOREACH(_EXE ${_EXE_LIST_${_CURRENT_TEST_DIRECTORY}})
  ...
  IF(CPPUNIT_FOUND)
    ...
    IF(APPLE)
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT \"DYLD_LIBRARY_PATH=@LD_LIBRARY_PATH@:@SICONOS_LIB_PATH@)\n")
