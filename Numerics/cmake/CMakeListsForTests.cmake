...
FOREACH(_EXE ${_EXE_LIST_${_CURRENT_TEST_DIRECTORY}})
  ...
  IF(CPPUNIT_FOUND)
    ...
    ELSEIF(CROSSCOMPILING_LINUX_TO_WINDOWS OR WINDOWS)
      FILE(APPEND ${CMAKE_CURRENT_BINARY_DIR}/SiconosTestConfig.cmake "  SET_TESTS_PROPERTIES(\${_EXE} PROPERTIES ENVIRONMENT \"Path=@PATH_FOR_PLUGIN@\;@CMAKE_BINARY_DIR@/src\;\")\n")
    ELSE() # unix
