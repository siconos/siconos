// generated with the command : ../tools/builder -I/scratch/Olivier/install/usr/local/include/Siconos/Kernel/ -I/scratch/Olivier/install/usr/local/include/Siconos/Numerics/ -I/usr/include/libxml2
