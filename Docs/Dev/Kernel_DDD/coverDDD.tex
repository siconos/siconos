...
\textsf{\textbf{Date~:} April 20, 2005}\\
...
\hline
Date : &\textsf{April 20, 2005}\\
Current version number : &\textsf{1.2}\\ 
Status :&$\bigcirc$ in progress \\
& $\bigotimes$ validated\\
\textit{ }& \hspace{0.5cm} Approved by : Barbier Jean-Michel\\
\hline
\end{tabular}
...
\hline
\hline
Date of issue : &\textsf{June 10, 2004}\\
...
\hline
\hline
Date of issue : &\textsf{September 3, 2004}\\
Current version number : &\textsf{1.2}\\ 
...
\hline
\hline
Date of issue : &\textsf{April 20, 2005}\\
Current version number : &\textsf{1.3}\\ 
Validated by :& \textsf{Vincent Acary}\\
\hline
Document change record since last version : &\textsf{"Modifications of the platform loading chapters"} \\
& \textsf{"Update of class and sequence diagrams"} \\
\hline
\hline
Date of issue : &\textsf{May 10, 2005}\\
Current version number : &\textsf{1.3}\\ 
Validated by :& \textsf{Franck P\'erignon}\\
\hline
Document change record since last version : &\textsf{"Guidelines for new objects implementation''} \\
\hline
\end{tabular}
