...
\item Team INRIA (C01):
  \begin{list}{-}{}
  \item Vincent Acary (VA) (Team Leader, designer, programmer) Vincent.Acary@inrialpes.fr
  ...
  \item Franck Pérignon (FP) (programmer, test engineer , numerical algorithms)
  \end{list}
\item  Team LMGC (AC2):
  \begin{list}{-}{}
  ...
  \end{list}
\item Team Analysis (CR6,CR4,CR9,AC5,CR7,AC12,CR8),
  \begin{itemize}
  \item Key developers
    \begin{description}
    \item[Gustavo Osorio (GA):] gosorio@unina.it
    \item[Ivan Merillas (IM):] merillas@mat.upc.edu
    \item[Petri Piiroinen (PP) (Team Leader, designer):] petri.piiroinen@bristol.ac.uk
    \end{description}
  \item Developers
    \begin{description}
    \item[Fabiola Angulo (FA):] fangulo@nevado.manizales.unal.edu.co
    \item[Alan Champneys (AC):]     a.r.champneys@bristol.ac.uk             
    \item[Enric Fossas (EF):] enric.fossas@upc.edu
    \item[Gino Iannelli (GI):] luigi.iannelli@unisannio.it
    \item[Arne Nordmark (AN):] nordmark@mech.kth.se
    \item[Gerard Olivar (GO):] gerard@mat.upc.edu
    \end{description}
    
  \item Testing team
    \begin{description}
    \item[Mario {di Bernardo} (MdB):] m.dibernardo@bristol.ac.uk
    \item[Kanat Camlibel (KC):] k.camlibel@uvt.nl
    \item[Ugo Galvanetto (UG):] u.galvanetto@imperial.ac.uk
    \item[Stefania Santini (SS):] stsantini@unina.it
    \item[David Wagg (DW):] david.wagg@bristol.ac.uk
    \item[Nathan van der Wouw (NW):] n.v.d.wouw@tue.nl               
    \end{description}       
  \end{itemize}
...
\item 2200 Detailed Design phase 
  ...
  \item 2230 Third Increment Production
    ...
    \item 2235 NSS pack for block sparse matrices
    \end{itemize}
  \end{itemize}
...
\begin{itemize}
        \item 4100 Software requirements phase SRD
                \begin{itemize}
                        \item 4110 First Increment Production           
                                \begin{itemize}
                                        \item 4111 Requirements elicitation
                                        \item 4112 Prototyping and Logical Model
                                        \item 4113 Anaylys/SRD draft
                                                                           
                                \end{itemize}
                        \item 4120 Second Increment Production
                                \begin{itemize}
                                        \item 4121 Update Analysis/SRD according to academical users feedback
                                \end{itemize}                   
                        \item 4130 Third Increment Production
                                \begin{itemize}
                                        \item 4131 Update Analysis/SRD according to industrial users feedback
                                \end{itemize}                   
                \end{itemize}
        \item 4200 External Specification phase 
                \begin{itemize}
                        \item 4210 First Increment Production
                                \begin{itemize}
                                        \item 4211 Specify software using context
                                        \item 4212 Specify interfaces
                                        \item 4213 Input/Output data description
                                        \item 4214 Error cases                                                          
                                \end{itemize}                                   
                        \item 4220 Second Increment Production
                        \item 4230 Third Increment Production
                \end{itemize}
        \item 4300 Architectural Design phase ADD
                \begin{itemize}
                        \item 4310 First Increment Production           
                                \begin{itemize}
                                        \item 4312 Prototyping and Physical Model
                                        \item 4313 Analysis/ADD draft
                                        \item 4314 Analysis/ADD final                                                             
                                                \begin{itemize}
                                                        \item 4314.1 SA/SD method application
                                                        \item 4313.2 Unit descriptions
                                                        \item 4314.3 Simuation course                                                           
                                        \end{itemize}
                                \end{itemize}
                        \item 4320 Second Increment Production
                        \item 4330 Third Increment Production
                \end{itemize}
        \item 4400 Detailed design phase
                \begin{itemize}
                        \item 4410 First Increment Production           
                                \begin{itemize}
                                        \item 4411 First increments of the anlysis/ADD
                                                \begin{itemize}
                                                        \item 4411.1 Brute-force Bifurcation diagrams
                                                        \item 4411.2 Domain of attraction calculations
                                                \end{itemize}                                   
                                        \item 4412 First version of the code
                                \end{itemize}
                        \item 4420 Second Increment Production          
                                \begin{itemize}
                                        \item 4421 Addition to the Analysis/ADD
                                                \begin{itemize}
                                                        \item 4421.1 Location of fixed points
                                                        \item 4421.2 Location of limit cycles
                                                        \item 4421.3 Continuation of fixed points
                                                        \item 4421.4 Continuation of limit cycles
                                                \end{itemize}                                   
                                        \item 4422 Updated version of the code
                                \end{itemize}
                        \item 4430 Third Increment Production           
                                \begin{itemize}
                                        \item 4431 Addition to the Analysis/DDD
                                                \begin{itemize}
                                                        \item 4431.1 Location of standard bifurcations of limit cycles
                                                        \item 4431.2 Location of nonsmooth bifurcations of limit cycles
                                                        \item 4431.3 Continuation of standard bifurcations of limit cycles
                                                        \item 4431.4 Continuation of nonsmooth bifurcations of limit cycles
                                                \end{itemize}                                   
                                        \item 4432 Updated version of the code
                                \end{itemize}
                \end{itemize}
        \item 4500 Unit testing
                \begin{itemize}
                        \item 4510 First Increment Testing
                                \begin{itemize}
                                        \item 4511 Template systems and benchmark definitions
                                        \item 4512 Integration Testing                                  
                                        \item 4513 System Testing                                       
                                        \item 4514 Acceptance Testing
                                \end{itemize}
                        \item 4520 Second Increment Testing                                     
                                \begin{itemize}
                                        \item 4521 Template systems and benchmark definitions
                                        \item 4522 Integration Testing                                  
                                        \item 4523 System Testing                                       
                                        \item 4524 Acceptance Testing
                                \end{itemize}
                        \item 4530 Third Increment Testing
                                \begin{itemize}
                                        \item 4531 Template systems and benchmark definitions
                                        \item 4532 Integration Testing                                  
                                        \item 4533 System Testing                                       
                                        \item 4534 Acceptance Testing
                                \end{itemize}
                \end{itemize}   
        \item 4600 Transfer phase Acceptance testing                    
                \begin{itemize}
                        \item 4610 First Increment Testing
                        \item 4620 Second Increment Testing                                     
                        \item 4630 Third Increment Testing
                \end{itemize}
\end{itemize}   
...
\begin{longtable}{|l|l|l|}
  ...
  % \endhead
  \textsf{M1.a} 
  & --- \ac{numerics}: \ac{ssd} draft and NSS pack & March 2004 \\
  ...
  % & \textsf{0000 }&\\
  & ---           Kernel 2 : Numerics integration, Numerical and model formalisation  & January 2005 \\
  \hline
  \textsf{M3.b} 
  ...
  % & \textsf{0000}&\\
  & ---           Kernel 3 : First Benchmarks and Demonstation examples &  March 2005 \\
  % & \textsf{0000}&\\
  \hline
  \textsf{M4.a} 
  ...
  % & \textsf{0000 }&\\
  & ---          Analysis : Evaluation of the Kernel and Numerics (T1)  & June 2005  \\
  ...
  & --- Analysis : First development increment complete  (T2 \& T3)  &  September 2005 \\
  % &  \textsf{0000}&\\
  \hline
  \textsf{M4.c} 
  & --- Analysis : First validation increment complete  (E2 \& E3)  &  December 2005 \\
  % &  \textsf{0000}&\\
  \hline
  \textsf{M5} 
  & ---    Analysis : Second  development increment complete  (T4 \& T5)&  \\
  & ---    Control : First increment complete \ac{tbc} & March 2006 \\
  % & \textsf{5000}&\\   
  \hline
  \textsf{M6} 
  & ---    Analysis : Second validation increment complete  (E4 \& E4 \& E6)   & September 2006 \\
