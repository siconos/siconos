...
In this section we present more precisely the six major functionalities of the \ac{siconos} software. In section~\ref{Sec:SRD-SpecificRequirements} we classify these specifications. In this section the relation between the functionalities are explicitly stated.
...
\hline\hline
\textbf{\ac{siconos}/Numerics}  & Low level numerical tools \\\hline
\textbf{\ac{siconos}/Engine}  & Modelling and numerical simulation \\\hline
 \textbf{\ac{siconos}/Front-End} & Command interactive user interface\\\hline
 \textbf{\ac{siconos}/Analysis}  & Analysis of solution\\\hline
 \textbf{\ac{siconos}/Control}  & Control design and validation\\\hline
 \textbf{\ac{siconos}/IMSE}  & Pre- and Post-Processing\\
\hline
  \end{tabular}
...
%% \end{ndrva}
\subsection{\ac{siconos}/Engine. Modelling and Simulation tools}
...
%% \begin{ndrva}
%%   Mettre une figure de ce module. Tous les aspects présents sur la figure doivent tre expliquer dans le texte.
%% \end{ndrva}
...
%\subsection{\ac{siconos}/Pre-Post-processing.}
%\label{Sec:SICONOS/pre-post}
% This module provides a  modelling and visualization environment for the \ac{siconos}/Engine based an the C++ API. Such a graphical  user interface  is  not planed, yet.
...
\begin{sidewaysfigure}
  \includegraphics[width=\textwidth-1cm]{./figure/Spec-v1-simple.eps}
\end{sidewaysfigure}
