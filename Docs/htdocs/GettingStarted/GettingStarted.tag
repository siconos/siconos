...
<tagfile>
  <compound kind="page">
    <name>index</name>
    <title>Getting Started with Siconos</title>
  ...
  <compound kind="page">
    <name>start_NSP</name>
    <title>Describing a Non Smooth Problem with Siconos</title>
    <filename>start_NSP</filename>
    <docanchor file="start_NSP">start_writingProcess</docanchor>
    <docanchor file="start_NSP">start_modelinPrinciple</docanchor>
  </compound>
  <compound kind="page">
    <name>doc_prelim</name>
    <title>Preliminaries</title>
    <filename>doc_prelim</filename>
    <docanchor file="doc_prelim">tutTempl</docanchor>
    <docanchor file="doc_prelim">cppPrelim</docanchor>
  ...
  <compound kind="page">
    ...
    <title>Siconos Plug-in Functions</title>
    <filename>doc_usingPlugin</filename>
  </compound>
  <compound kind="page">
    <name>UsingPython</name>
    <title>Using Python interface</title>
    <filename>UsingPython</filename>
  </compound>
  <compound kind="page">
    <name>usingxml</name>
