...
set(CMAKE_MODULE_PATH ${CTEST_SOURCE_DIRECTORY}/CI/cmake)

include(Tools)

# options passed from cmake configuration command
...
set(CTEST_CONFIGURE_COMMAND "${CMAKE_WRAPPER} \"-G${CTEST_CMAKE_GENERATOR}\" -DCMAKE_BUILD_TYPE:STRING=${CTEST_BUILD_CONFIGURATION} ${CI_OPTIONS} ${CTEST_BUILD_OPTIONS}")
