...
set(CTEST_CONFIGURE_COMMAND "${CMAKE_WRAPPER} \"-G${CTEST_CMAKE_GENERATOR}\" -DCMAKE_BUILD_TYPE:STRING=${CTEST_BUILD_CONFIGURATION} -DBUILDNAME:STRING=${MODULE} ${CMAKE_FLAGS} ${CTEST_BUILD_OPTIONS}")
