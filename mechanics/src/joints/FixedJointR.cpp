...
void siconos::joints::FixedJointR::setBasePositions(
  ...
  ::boost::math::quaternion<double> quatG10G20_abs(0, (q2 ? (*q2)(0) : 0) - q1(0),
                                                   (q2 ? (*q2)(1) : 0) - q1(1),
                                                   (q2 ? (*q2)(2) : 0) - q1(2));
...
void siconos::joints::FixedJointR::computeH_NE_(double time,
...
void siconos::joints::FixedJointR::Jd1d2(double X1, double Y1, double Z1, double q10,
  ...
  H_NE_view_->setValue(0, 0, -pow(q10, 2) - pow(q11, 2) + pow(q12, 2) + pow(q13, 2));
  ...
  H_NE_view_->setValue(1, 1, -pow(q10, 2) + pow(q11, 2) - pow(q12, 2) + pow(q13, 2));
  ...
  H_NE_view_->setValue(2, 2, -pow(q10, 2) + pow(q11, 2) + pow(q12, 2) - pow(q13, 2));
  ...
  H_NE_view_->setValue(5, 3,
                       -_cq2q101 * q23 + _cq2q102 * q22 - _cq2q103 * q21 - _cq2q104 * q20);
  H_NE_view_->setValue(5, 4,
                       -_cq2q101 * q22 - _cq2q102 * q23 - _cq2q103 * q20 + _cq2q104 * q21);
  H_NE_view_->setValue(5, 5,
                       _cq2q101 * q21 + _cq2q102 * q20 - _cq2q103 * q23 + _cq2q104 * q22);
  H_NE_view_->setValue(5, 6,
                       _cq2q101 * q20 - _cq2q102 * q21 - _cq2q103 * q22 - _cq2q104 * q23);
  H_NE_view_->setValue(5, 7, 0);
  H_NE_view_->setValue(5, 8, 0);
  H_NE_view_->setValue(5, 9, 0);
  H_NE_view_->setValue(5, 10,
                       _cq2q101 * q13 + _cq2q102 * q12 - _cq2q103 * q11 - _cq2q104 * q10);
  H_NE_view_->setValue(5, 11,
                       _cq2q101 * q12 - _cq2q102 * q13 - _cq2q103 * q10 + _cq2q104 * q11);
  H_NE_view_->setValue(5, 12,
                       -_cq2q101 * q11 + _cq2q102 * q10 - _cq2q103 * q13 + _cq2q104 * q12);
  H_NE_view_->setValue(5, 13,
                       -_cq2q101 * q10 - _cq2q102 * q11 - _cq2q103 * q12 - _cq2q104 * q13);
}
