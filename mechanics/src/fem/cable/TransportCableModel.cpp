...
TransportCableModel::TransportCableModel()
{
}
...
int TransportCableModel::from_json(const json & j)
{
	...
	std::map<string, BaseModel&> vElems = {
			{ "cable", m_cable },
			{ "carriers", m_carriers },
...
const Cable & TransportCableModel::get_cable() const
{
	return m_cable;
}

const Carriers & TransportCableModel::get_carriers() const
{
	return m_carriers;
}

const vector<Pile>& TransportCableModel::get_piles1() const
{
	return m_pilesUp;
}

const vector<Pile>& TransportCableModel::get_piles2() const
{
	return m_pilesDown;
}
