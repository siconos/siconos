...
#include "siconos_btSphereSphereCollisionAlgorithm.h"
...
siconos_btSphereSphereCollisionAlgorithm::siconos_btSphereSphereCollisionAlgorithm(
...
void siconos_btSphereSphereCollisionAlgorithm::processCollision(
    const btCollisionObjectWrapper* col0Wrap, const btCollisionObjectWrapper* col1Wrap,
  ...
  btVector3 diff =
      col0Wrap->getWorldTransform().getOrigin() - col1Wrap->getWorldTransform().getOrigin();
...
btScalar siconos_btSphereSphereCollisionAlgorithm::calculateTimeOfImpact(
    btCollisionObject* col0, btCollisionObject* col1, const btDispatcherInfo& dispatchInfo,
