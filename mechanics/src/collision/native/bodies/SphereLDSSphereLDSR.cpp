    ...
    const siconos::algebra::BlockVector& q, siconos::algebra::BlockVector& z)
{
  ...
  jacobianhOver_q_->setValue(0, 6, x62);
  jacobianhOver_q_->setValue(0, 7, x70);
  jacobianhOver_q_->setValue(0, 8, x60);
  jacobianhOver_q_->setValue(0, 9, 0);
  ...
  jacobianhOver_q_->setValue(1, 3, x80);
  jacobianhOver_q_->setValue(1, 4, x2);
  jacobianhOver_q_->setValue(1, 5, x79 - x52);
  jacobianhOver_q_->setValue(1, 6, x61);
  jacobianhOver_q_->setValue(1, 7, x57);
  jacobianhOver_q_->setValue(1, 8, x67);
  jacobianhOver_q_->setValue(1, 9, x78);
  jacobianhOver_q_->setValue(1, 10, x14);
  jacobianhOver_q_->setValue(1, 11, x74 - x54);
  jacobianhOver_q_->setValue(2, 0, v1);
  jacobianhOver_q_->setValue(2, 1, v2);
  jacobianhOver_q_->setValue(2, 2, v3);
  jacobianhOver_q_->setValue(2, 3, x76);
  jacobianhOver_q_->setValue(2, 4, x27);
  jacobianhOver_q_->setValue(2, 5, x75 - x50);
  jacobianhOver_q_->setValue(2, 6, v1);
  jacobianhOver_q_->setValue(2, 7, v2);
  jacobianhOver_q_->setValue(2, 8, v3);
  jacobianhOver_q_->setValue(2, 9, x77);
  jacobianhOver_q_->setValue(2, 10, x37);
  jacobianhOver_q_->setValue(2, 11, x81 - x55);
};
