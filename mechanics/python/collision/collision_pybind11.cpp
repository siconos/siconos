...
PYBIND11_MODULE(_collision, m) {
  ...
  py::classh<siconos::collision::SiconosShape>(m, "SiconosShape")
  ...
  py::classh<siconos::collision::SiconosSphere, siconos::collision::SiconosShape>(
      m, "SiconosSphere")
  ...
  py::classh<siconos::collision::SiconosBox, siconos::collision::SiconosShape>(m, "SiconosBox")
  ...
  py::classh<siconos::collision::SiconosCylinder, siconos::collision::SiconosShape>(
      m, "SiconosCylinder")
  ...
  py::classh<siconos::collision::SiconosCone, siconos::collision::SiconosShape>(m,
                                                                                "SiconosCone")
      .def(py::init<float, float>(), py::arg("radius"), py::arg("length"))
  ...
  py::classh<siconos::collision::SiconosCapsule, siconos::collision::SiconosShape>(
      m, "SiconosCapsule")
      .def(py::init<float, float>(), py::arg("radius"), py::arg("length"))
  ...
  py::classh<siconos::collision::SiconosPlane, siconos::collision::SiconosShape>(
      m, "SiconosPlane")
      .def(py::init());

  py::classh<siconos::collision::SiconosConvexHull, siconos::collision::SiconosShape>(
      m, "SiconosConvexHull")
      .def(py::init<Eigen::Ref<siconos::algebra::SiconosMatrix>>(),
           py::arg("vertices"));  // TODO : WARNING with vertices argument, it is shard ptr

  py::classh<siconos::collision::SiconosDisk, siconos::collision::SiconosShape>(m,
                                                                                "SiconosDisk")
      .def(py::init<float>(), py::arg("radius"))
      .def("radius", &siconos::collision::SiconosDisk::radius)
      .def("setRadius", &siconos::collision::SiconosDisk::setRadius);

  py::classh<siconos::collision::SiconosBox2d, siconos::collision::SiconosShape>(
      m, "SiconosBox2d")
      .def(py::init<double, double>(), py::arg("width"), py::arg("height"));

  py::classh<siconos::collision::SiconosConvexHull2d, siconos::collision::SiconosShape>(
      m, "SiconosConvexHull2d")
      .def(py::init<Eigen::Ref<siconos::algebra::SiconosMatrix>>(),
           py::arg("vertices"));  // TODO : WARNING with vertices argument, it is shard ptr

  py::classh<siconos::collision::SiconosContactor>(m, "SiconosContactor")
  ...
  py::classh<siconos::collision::SiconosContactorSet>(m, "SiconosContactorSet")
      .def(py::init<>())
      .def("append",
  ...
  py::classh<siconos::collision::SiconosMesh, siconos::collision::SiconosShape>(m,
                                                                                "SiconosMesh")
  ...
  py::classh<siconos::collision::SiconosHeightMap, siconos::collision::SiconosShape>(
      m, "SiconosHeightMap")
      .def(py::init<Eigen::Ref<siconos::algebra::SiconosMatrix>, double, double>(),
           py::keep_alive<1, 1>(), py::arg("height_data"), py::arg("length_x"),
           py::arg("length_y"));

  py::classh<siconos::collision::native::SpaceFilter, siconos::simulation::InteractionManager>(
      m, "SpaceFilter")
      .def(py::init<>())
  ...
  py::classh<siconos::collision::native::bodies::CircularDS, siconos::modeling::LagrangianDS>(
      m, "CircularDS")
  ...
  py::classh<siconos::collision::native::bodies::Circle,
  ...
  py::classh<siconos::collision::native::bodies::Disk,
  ...
  py::classh<siconos::collision::StaticBody>(m, "StaticBody").def(py::init<>());

  py::classh<siconos::collision::RigidBodyDS, siconos::modeling::NewtonEulerDS>(m,
                                                                                "RigidBodyDS")
  ...
  py::classh<siconos::collision::RigidBody2dDS, siconos::modeling::LagrangianLinearTIDS>(
      m, "RigidBody2dDS")
  ...
  py::classh<siconos::collision::BodyShapeRecord>(m, "BodyShapeRecord")
      .def("__repr__", [](const siconos::collision::BodyShapeRecord& a) {
        a.display();
        return "\n";
      });

  py::classh<siconos::collision::Contact2d3DR, siconos::modeling::Lagrangian2d3DR>(
      m, "Contact2d3DR")
      .def_readwrite("bodyShapeRecordA", &siconos::collision::Contact2d3DR::bodyShapeRecordA)
      .def_readwrite("bodyShapeRecordB", &siconos::collision::Contact2d3DR::bodyShapeRecordB);
}
