...
if(WITH_${COMPONENT}_TESTING)
  ...
  new_test_1(SOURCES MultiBodyTest.cpp ${SIMPLE_TEST_MAIN})

  if(WITH_BULLET)
    begin_tests(src/collision/bullet/test DEPS "numerics;kernel;CPPUNIT::CPPUNIT")
    new_test_1(SOURCES  ContactTest.cpp ${SIMPLE_TEST_MAIN})
    new_test_1(SOURCES  Contact2dTest.cpp ${SIMPLE_TEST_MAIN})
  endif()
  
  if(WITH_OCE)
    begin_tests(src/occ/test DEPS "kernel;CPPUNIT::CPPUNIT")
    new_test_1(SOURCES  OccTest.cpp ${SIMPLE_TEST_MAIN})
  endif()
