...
set ylabel "V"
plot\
  resultfile u 1:2 t      "capacitor voltage , SICONOS BE 1us" w points 
set origin 0.0,winheight*2.0+heightoff
set ylabel "A"
plot\
  resultfile u 1:3 t      "inductor current , SICONOS BE 1us" w l
set origin 0.0,winheight+heightoff
set ylabel "V"
plot\
  resultfile u 1:4 t      "diode voltage , SICONOS BE 1us" w l
...
set ylabel "A"
plot\
  resultfile u 1:5 t      "diode current , SICONOS BE 1us" w l
set nomultiplot
