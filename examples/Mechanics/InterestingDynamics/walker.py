...
with Hdf5() as io:
    ...
    io.add_joint('joint1', 'bar2', 'bar1', [[4.5, 0, 0]], [[0, 1, 0]], 'PivotJointR', absolute=False)
    io.add_joint('joint2', 'bar3', 'bar1', [[4.5, 0, 0]], [[0, 1, 0]], 'PivotJointR', absolute=False)
    io.add_joint('joint3', 'bar4', 'bar1', [[4.5, 0, 0]], [[0, 1, 0]], 'PivotJointR', absolute=False)
    io.add_joint('joint4', 'bar5', 'bar1', [[4.5, 0, 0]], [[0, 1, 0]], 'PivotJointR', absolute=False)
