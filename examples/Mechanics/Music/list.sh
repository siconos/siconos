...
oarsub -S "./run.sh 16056320 1024" -p "network_address='luke42'" -t timesharing=perignon,*
oarsub -S "./run.sh 8028160 512" -p "network_address='luke42'" -t timesharing=perignon,*
oarsub -S "./run.sh 4014080 256" -p "network_address='luke42'" -t timesharing=perignon,*
oarsub -S "./run.sh 2007040 128" -p "network_address='luke42'" -t timesharing=perignon,*
