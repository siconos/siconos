...
int main(int argc, char* argv[])
{
  try
  {
    ...
    SP::Interaction inter1(new Interaction(nslaw1, relation1, 1));
    ...
    SP::Interaction inter2(new Interaction(nslaw2, relation2, 2));
    ...
    SP::Interaction inter3(new Interaction(nslaw3, relation3, 3));
    ...
    SP::Interaction inter4(new Interaction(nslaw4, relation4, 4));
#else
    // -- corner 1 --
