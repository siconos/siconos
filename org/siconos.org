...
** TODO Add an empty ComputeFreeOutput in Moreau2 to simplify computeqBlock in LinearOSNS
...
** TODO [50%] Insert the MBTB of Saladyn in Siconos (siconos GPL Licence)
*** DONE first import.
    CLOSED: [2013-03-03 Dim 09:36]
*** TODO check header licence and so on
