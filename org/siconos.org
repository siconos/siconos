...
We are currently working on the release candidate 4.1.0 that can be forked from our github repo. 

We have also worked our documentation at  http://siconos.gforge.inria.fr even if it lacks of polishing. 
