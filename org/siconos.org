...
A brand new Siconos 4.0.0 is out !! Siconos is now ditributed under Apache 2.0 license.

The source code (zip and tar.gz) can be found on github : https://github.com/siconos/siconos/releases
We are currenlty working on the release candidate 4.1.0 that can be forked from our github repo. 

We have also try to work our documentation at  http://siconos.gforge.inria.fr even if it lacks of polishing. 

As usual, your feedback comments are welcome.

We start also to feed our YouTube channel https://www.youtube.com/channel/UCgv2siTCJeSdWFPTDk71Iyw If you have nice applications with Siconos, do not hesitate to contribute.
