...
typedef Sensor* (*object_creator)(const std::string&, TimeDiscretisation*) ;
...
template<class SubType> Sensor* factory(const std::string& name, TimeDiscretisation* t)
{
...
public :
   ...
   */
  Sensor* instantiate(const std::string&, TimeDiscretisation*);
