//$Id: SiconosMatrixException.h,v 1.1 2004/09/10 10:00:21 charlety Exp $
...
*
* $Date: 2004/09/10 10:00:21 $
* $Revision: 1.1 $
* $Author: charlety $
* $Source: /CVS/Siconos/SICONOS/src/utils/NewSiconosVector/SiconosMatrixException.h,v $
*
*
