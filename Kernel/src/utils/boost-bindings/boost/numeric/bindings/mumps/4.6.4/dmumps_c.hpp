...
*/
/* $Id: dmumps_c.hpp 3346 2012-06-19 16:21:40Z bremond $ */
...
typedef struct
{
  ...
  DMUMPS_DOUBLE *colsca;
  DMUMPS_DOUBLE *rowsca;
  ...
  /* Null space */
  DMUMPS_INT deficiency;
  DMUMPS_DOUBLE * nullspace;
  DMUMPS_INT * mapping;
  /* Schur */
  DMUMPS_INT size_schur;
