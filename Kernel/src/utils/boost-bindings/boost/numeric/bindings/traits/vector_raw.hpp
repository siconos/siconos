...
BOOST_UBLAS_INLINE
int vector_stride(const ublas::vector<T, A> &v)
{
  return 1;
}
template <typename V>
...
BOOST_UBLAS_INLINE
int vector_stride(const ublas::c_vector<T, N> &v)
{
  return 1;
}
template <typename V>
...
template <typename T, typename A>
BOOST_UBLAS_INLINE
int vector_stride(const std::vector<T, A> &v)
{
  return 1;
}
...
template <typename T>
BOOST_UBLAS_INLINE
int vector_stride(const detail::array<T> &a)
{
  return 1;
}
...
template <typename T>
BOOST_UBLAS_INLINE
const T* vector_storage(const detail::array<T> &a)
{
  return a.storage();
}
#endif
...
template <typename T>
BOOST_UBLAS_INLINE
T* vector_storage(detail::array<T> &a)
{
  return a.storage();
}
