...
public:
  ...
  static std::ptrdiff_t num_rows(matrix_type& cm)
  {
    return cm.size1();
  }
  static std::ptrdiff_t num_columns(matrix_type& cm)
  {
    return cm.size2();
  }
...
public:
  ...
  static int num_rows(matrix_type& cm)
  {
    return cm.size1();
  }
  static int num_columns(matrix_type& cm)
  {
    return cm.size2();
  }
