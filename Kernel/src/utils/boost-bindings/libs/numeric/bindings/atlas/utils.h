...
struct vct_access_traits
{
  ...
  typedef val_t& ref_t;
  static ref_t elem(V& v, size_t i)
  {
    return v[i];
  }
};
...
struct vct_access_traits<V const>
{
  ...
  boost::numeric::bindings::traits::vector_traits<V>::value_type val_t;
  typedef val_t ref_t;
  static ref_t elem(V const& v, size_t i)
  {
    return v[i];
  }
};
...
struct vct_access_traits<const V[N]>
{
  typedef V val_t;
  typedef val_t ref_t;
  static ref_t elem(const V v[N], size_t i)
  {
    return v[i];
  }
};
...
struct matr_access_traits
{
  ...
  //typedef val_t& ref_t;
  static ref_t elem(M& m, size_t i, size_t j)
  {
    return m(i, j);
  }
};
...
struct matr_access_traits<M const>
{
  ...
  boost::numeric::bindings::traits::matrix_traits<M>::value_type val_t;
  typedef val_t ref_t;
  static ref_t elem(M const& m, size_t i, size_t j)
  {
    return m(i, j);
  }
};
...
struct rws
{
  size_t operator()(size_t i, size_t) const
  {
    return i;
  }
};
...
struct cls
{
  size_t operator()(size_t, size_t j) const
  {
    return j;
  }
};
