...
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
                                             VisitMaker<T3, 
                                                        VisitMaker<T4, 
                                                                   VisitMaker<T5, 
...
struct Visitor<T1, empty, empty, empty, empty, empty, empty, empty, empty> 
{
  template<typename T>
  struct Make : public VisitMaker<T1, T>{};
};

template<typename T1, typename T2>
struct Visitor<T1, T2, empty, empty, empty, empty, empty, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, VisitMaker<T2, T> >
  {};
};

template<typename T1, typename T2, typename T3>
struct Visitor<T1, T2, T3, empty, empty, empty, empty, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
...
struct Visitor<T1, T2, T3, T4, empty, empty, empty, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
...
struct Visitor<T1, T2, T3, T4, T5, empty, empty, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
...
struct Visitor<T1, T2, T3, T4, T5, T6, empty, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
                                             VisitMaker<T3, 
                                                        VisitMaker<T4, 
                                                                   VisitMaker<T5, VisitMaker<T6, T> 
                                                                              > > > > > 
  {};
};

template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
struct Visitor<T1, T2, T3, T4, T5, T6, T7, empty, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
...
struct Visitor<T1, T2, T3, T4, T5, T6, T7, T8, empty>
{
  template<typename T>
  struct Make : public VisitMaker<T1, 
                                  VisitMaker<T2, 
