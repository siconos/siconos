 ...
 * friction contact problem in 2D defined by :
 *  * \f[
 * w =  q + M z
 * \f]
 * \f[
 ...
 */
class FrictionContact2D : public OneStepNSProblem
{
private:

  /** contains the vector w of a FrictionContact2D system */
  SimpleVector *w;

  /** contains the vector z of a FrictionContact2D system */
  SimpleVector *z;

  /** contains the matrix M of a FrictionContact2D system */
  SiconosMatrix *M;

  /** contains the vector q of a FrictionContact2D system */
  SimpleVector *q;
...
public:
  ...
  /** \fn FrictionContact2D(Strategy*, const string& solverName, const string& newSolvingMethod, const int& maxIter,
   ...
   */
  FrictionContact2D(Strategy * , const std::string& = "none", const std::string& = "none",
  ...
  /** \fn void initialize()
   *  \brief initialize the FrictionContact2D problem(compute topology ...)
   */
  ...
  /** \fn void preFrictionContact2D(const double& time)
   *  \brief pre-treatment for FrictionContact2D
   *  \param double : current time
   *  \return void
   */
  void preFrictionContact2D(const double& time);
  ...
  /** \fn void postFrictionContact2D(const SimpleVector& w, SimpleVector& z)
   *  \brief post-treatment for FrictionContact2D
   *  \param 2 simple vectors: output of FrictionContact2D solver
   *  \return void
   */
  void postFrictionContact2D(const SimpleVector&, const SimpleVector&);
