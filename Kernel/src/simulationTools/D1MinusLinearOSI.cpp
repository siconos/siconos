...
double D1MinusLinearOSI::computeResidu()
{
  ...
  case explicit_acceleration_level:
    return computeResidu_explicit_acceleration_level();
  case explicit_acceleration_level_full:
    return computeResidu_explicit_acceleration_level_full();
...
double D1MinusLinearOSI::computeResidu_explicit_acceleration_level()
{
...
double D1MinusLinearOSI::computeResidu_explicit_acceleration_level_full()
{
