 ...
 * friction contact problem in 3D defined by :
 *  * \f[
 * w =  q + M z
 * \f]
 * \f[
 ...
 */
class FrictionContact3D : public OneStepNSProblem
{
private:

  /** contains the vector w of a FrictionContact3D system */
  SimpleVector *w;

  /** contains the vector z of a FrictionContact3D system */
  SimpleVector *z;

  /** contains the matrix M of a FrictionContact3D system */
  SiconosMatrix *M;
...
public:
   ...
   */
  FrictionContact3D(Strategy * , const std::string& = "none", const std::string& = "none",
  ...
  /** \fn void initialize()
   *  \brief initialize the FrictionContact3D problem(compute topology ...)
   */
  ...
  /** \fn void preFrictionContact3D(const double& time)
   *  \brief pre-treatment for FrictionContact3D
   *  \param double : current time
   *  \return void
   */
  void preFrictionContact3D(const double& time);
  ...
  /** \fn void postFrictionContact3D(const SimpleVector& w, SimpleVector& z)
   *  \brief post-treatment for FrictionContact3D
   *  \param 2 simple vectors: output of FrictionContact3D solver
   *  \return void
   */
  void postFrictionContact3D(const SimpleVector&, const SimpleVector&);
