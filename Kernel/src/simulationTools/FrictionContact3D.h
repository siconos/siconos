...
public:
  ...
  /** \fn FrictionContact3D(OneStepNSProblemXML*, Simulation*)
  ...
  /** \fn FrictionContact3D(Simulation * , const std::string, const std::string =DEFAULT_SOLVER, const unsigned int = DEFAULT_ITER, const double = DEFAULT_TOL,
  ...
  /** \fn FrictionContact3D(Solver*, Simulation*, const std::string id = DEFAULT_OSNS_NAME)
   *  \brief constructor from data
