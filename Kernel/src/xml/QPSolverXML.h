 ...
 */
/** \class QPSolverXML
 *   \brief XML data management for class QPSolver
...
#ifndef __QPSOLVERXML__
#define __QPSOLVERXML__
...
class QPSolverXML : public SolverXML
{
private:

  /** \fn QPSolverXML(xmlNodePtr)
...
public:
   ...
   */
  QPSolverXML(xmlNodePtr);

  /** \fn QPSolverXML(xmlNodePtr, xmlNodePtr, xmlNodePtr)
   ...
   */
  QPSolverXML(xmlNodePtr, xmlNodePtr, xmlNodePtr);
