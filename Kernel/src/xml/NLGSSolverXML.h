 ...
 */
/** \class NLGSSolverXML
 *   \brief XML data management for class NLGSSolver
...
#ifndef __NLGSSOLVERXML__
#define __NLGSSOLVERXML__
...
class NLGSSolverXML : public SolverXML
{
private:

  /** \fn NLGSSolverXML(xmlNodePtr)
...
public:
   ...
   */
  NLGSSolverXML(xmlNodePtr);

  /** \fn NLGSSolverXML(xmlNodePtr, xmlNodePtr, xmlNodePtr)
   ...
   */
  NLGSSolverXML(xmlNodePtr, xmlNodePtr, xmlNodePtr);
