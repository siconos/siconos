...
NSQPSolverXML::NSQPSolverXML(xmlNodePtr solverNode):
  SolverXML(solverNode)
{}

NSQPSolverXML::NSQPSolverXML(xmlNodePtr solverNode, xmlNodePtr solvFNode, xmlNodePtr solvAlgNode):
...
double NSQPSolverXML::getTolerance() const
{
