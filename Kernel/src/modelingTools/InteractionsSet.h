...
typedef std::set<Interaction*, Cmp<Interaction, double*> >::iterator InteractionsIterator;
/** const Iterator through a set of Interactions */
typedef std::set<Interaction*, Cmp<Interaction, double*> >::const_iterator ConstInteractionsIterator;
